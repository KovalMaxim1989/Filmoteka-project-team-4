 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ja=new Bo(5e3,15e3),Ya="__/auth/iframe",Qa="emulator/auth/iframe",Za={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},tl=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function el(t){const e=t.config;Co(e.authDomain,t,"auth-domain-config-required");const n=e.emulator?Uo(e,Qa):`https://${t.config.authDomain}/${Ya}`,i={apiKey:e.apiKey,appName:t.name,v:Bt},r=tl.get(t.config.apiHost);r&&(i.eid=r);const o=t._getFrameworks();return o.length&&(i.fw=o.join(",")),`${n}?${F(i).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
...
//# sourceMappingURL=index.8adbadd1.js.map

var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{};function t(e){return e&&e.__esModule?e.default:e}var n={},i={},s=e.parcelRequired7c6;null==s&&((s=function(e){if(e in n)return n[e].exports;if(e in i){var t=i[e];delete i[e];var s={id:e,exports:{}};return n[e]=s,t.call(s.exports,s,s.exports),s.exports}var r=new Error("Cannot find module '"+e+"'");throw r.code="MODULE_NOT_FOUND",r}).register=function(e,t){i[e]=t},e.parcelRequired7c6=s),s("kyEFX").register(JSON.parse('{"5ZPII":"index.3b67f0f7.js","dATrs":"movie-pic.fe810275.jpg","lk5QZ":"library.c443c764.css","04m8d":"library.603a6295.js"}'));
/**
 * @license
 ...
 * limitations under the License.
 */
class ke{getPlatformInfoString(){return this.container.getProviders().map((e=>{if(function(e){const t=e.getComponent();return"VERSION"===(null==t?void 0:t.type)}(e)){const t=e.getImmediate();return`${t.library}/${t.version}`}return null})).filter((e=>e)).join(" ")}constructor(e){this.container=e}}const Se="@firebase/app",Ce="0.9.3",Ne=new oe("@firebase/app"),Ae="[DEFAULT]",xe={[Se]:"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},Le=new Map,De=new Map;function Re(e,t){try{e.container.addComponent(t)}catch(n){Ne.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function Pe(e){const t=e.name;if(De.has(t))return Ne.debug(`There were multiple attempts to register component ${t}.`),!1;De.set(t,e);for(const t of Le.values())Re(t,e);return!0}function Oe(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fe="9.17.1";function Ve(e,t={}){let n=e;if("object"!=typeof t){t={name:t}}const i=Object.assign({name:Ae,automaticDataCollectionEnabled:!1},t),s=i.name;if("string"!=typeof s||!s)throw Me.create("bad-app-name",{appName:String(s)});if(n||(n=N()),!n)throw Me.create("no-options");const r=Le.get(s);if(r){if(j(n,r.options)&&j(i,r.config))return r;throw Me.create("duplicate-app",{appName:s})}const o=new Y(s);for(const e of De.values())o.addComponent(e);const a=new Ue(n,i,o);return Le.set(s,a),a}function je(e=Ae){const t=Le.get(e);if(!t&&e===Ae)return Ve();if(!t)throw Me.create("no-app",{appName:e});return t}function Be(e,t,n){var i;let s=null!==(i=xe[e])&&void 0!==i?i:e;n&&(s+=`-${n}`);const r=s.match(/\s|\//),o=t.match(/\s|\//);if(r||o){const e=[`Unable to register library "${s}" with version "${t}":`];return r&&e.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&o&&e.push("and"),o&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void Ne.warn(e.join(" "))}Pe(new Q(`${s}-version`,(()=>({library:s,version:t})),"VERSION"))}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var et;et="",Pe(new Q("platform-logger",(e=>new ke(e)),"PRIVATE")),Pe(new Q("heartbeat",(e=>new Xe(e)),"PRIVATE")),Be(Se,Ce,et),Be(Se,Ce,"esm2017"),Be("fire-js","");
/**
 * @license
 ...
 * limitations under the License.
 */
Be("firebase","9.17.1","app");const tt={apiKey:"AIzaSyCf4tLspRq68Ljv4DBPIn8lepUq3CBW6kQ",authDomain:"filmoteka-bl6.firebaseapp.com",projectId:"filmoteka-bl6",storageBucket:"filmoteka-bl6.appspot.com",messagingSenderId:"513518233245",appId:"1:513518233245:web:28560022e0c985e2f09674",measurementId:"G-6CEWHL9KG0"};function nt(e,t,n){if(!t.has(e))throw new TypeError("attempted to "+n+" private field on non-instance");return t.get(e)}function it(e,t){return t.get?t.get.call(e):t.value}function st(e,t){return it(e,nt(e,t,"get"))}function rt(e,t){if(t.has(e))throw new TypeError("Cannot initialize the same private elements twice on an object")}function ot(e,t,n){rt(e,t),t.set(e,n)}function at(e,t,n){if(t.set)t.set.call(e,n);else{if(!t.writable)throw new TypeError("attempted to set read only private field");t.value=n}}function ct(e,t,n){return at(e,nt(e,t,"set"),n),n}var lt,ut,ht=s("2shzp"),dt={};lt=void 0!==e?e:"undefined"!=typeof window?window:dt,ut=function(e){if(void 0===e&&void 0===e.document)return!1;var t,n="Success",i="Failure",s="Warning",r="Info",o={wrapID:"NotiflixNotifyWrap",overlayID:"NotiflixNotifyOverlay",width:"280px",position:"right-top",distance:"10px",opacity:1,borderRadius:"5px",rtl:!1,timeout:3e3,messageMaxLength:110,backOverlay:!1,backOverlayColor:"rgba(0,0,0,0.5)",plainText:!0,showOnlyTheLastOne:!1,clickToClose:!1,pauseOnHover:!0,ID:"NotiflixNotify",className:"notiflix-notify",zindex:4001,fontFamily:"Quicksand",fontSize:"13px",cssAnimation:!0,cssAnimationDuration:400,cssAnimationStyle:"fade",closeButton:!1,useIcon:!0,useFontAwesome:!1,fontAwesomeIconStyle:"basic",fontAwesomeIconSize:"34px",success:{background:"#32c682",textColor:"#fff",childClassName:"notiflix-notify-success",notiflixIconColor:"rgba(0,0,0,0.2)",fontAwesomeClassName:"fas fa-check-circle",fontAwesomeIconColor:"rgba(0,0,0,0.2)",backOverlayColor:"rgba(50,198,130,0.2)"},failure:{background:"#ff5549",textColor:"#fff",childClassName:"notiflix-notify-failure",notiflixIconColor:"rgba(0,0,0,0.2)",fontAwesomeClassName:"fas fa-times-circle",fontAwesomeIconColor:"rgba(0,0,0,0.2)",backOverlayColor:"rgba(255,85,73,0.2)"},warning:{background:"#eebf31",textColor:"#fff",childClassName:"notiflix-notify-warning",notiflixIconColor:"rgba(0,0,0,0.2)",fontAwesomeClassName:"fas fa-exclamation-circle",fontAwesomeIconColor:"rgba(0,0,0,0.2)",backOverlayColor:"rgba(238,191,49,0.2)"},info:{background:"#26c0d3",textColor:"#fff",childClassName:"notiflix-notify-info",notiflixIconColor:"rgba(0,0,0,0.2)",fontAwesomeClassName:"fas fa-info-circle",fontAwesomeIconColor:"rgba(0,0,0,0.2)",backOverlayColor:"rgba(38,192,211,0.2)"}},a=function(e){return console.error("%c Notiflix Error ","padding:2px;border-radius:20px;color:#fff;background:#ff5549","\n"+e+"\n\nVisit documentation page to learn more: https://notiflix.github.io/documentation")},c=function(t){return t||(t="head"),null!==e.document[t]||(a('\nNotiflix needs to be appended to the "<'+t+'>" element, but you called it before the "<'+t+'>" element has been created.'),!1)},l=function(){var e={},t=!1,n=0;"[object Boolean]"===Object.prototype.toString.call(arguments[0])&&(t=arguments[0],n++);for(var i=function(n){for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(t&&"[object Object]"===Object.prototype.toString.call(n[i])?e[i]=l(e[i],n[i]):e[i]=n[i])};n<arguments.length;n++)i(arguments[n]);return e},u=function(){return'[id^=NotiflixNotifyWrap]{pointer-events:none;position:fixed;z-index:4001;opacity:1;right:10px;top:10px;width:280px;max-width:96%;-webkit-box-sizing:border-box;box-sizing:border-box;background:transparent}[id^=NotiflixNotifyWrap].nx-flex-center-center{max-height:calc(100vh - 20px);overflow-x:hidden;overflow-y:auto;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-wrap:wrap;-ms-flex-wrap:wrap;flex-wrap:wrap;-webkit-box-orient:vertical;-webkit-box-direction:normal;-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;-webkit-box-align:center;-webkit-align-items:center;-ms-flex-align:center;align-items:center;margin:auto}[id^=NotiflixNotifyWrap]::-webkit-scrollbar{width:0;height:0}[id^=NotiflixNotifyWrap]::-webkit-scrollbar-thumb{background:transparent}[id^=NotiflixNotifyWrap]::-webkit-scrollbar-track{background:transparent}[id^=NotiflixNotifyWrap] *{-webkit-box-sizing:border-box;box-sizing:border-box}[id^=NotiflixNotifyOverlay]{-webkit-transition:background .3s ease-in-out;-o-transition:background .3s ease-in-out;transition:background .3s ease-in-out}[id^=NotiflixNotifyWrap]>div{pointer-events:all;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;font-family:"Quicksand",-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif;width:100%;display:-webkit-inline-box;display:-webkit-inline-flex;display:-ms-inline-flexbox;display:inline-flex;-webkit-flex-wrap:wrap;-ms-flex-wrap:wrap;flex-wrap:wrap;-webkit-box-align:center;-webkit-align-items:center;-ms-flex-align:center;align-items:center;position:relative;margin:0 0 10px;border-radius:5px;background:#1e1e1e;color:#fff;padding:10px 12px;font-size:14px;line-height:1.4}[id^=NotiflixNotifyWrap]>div:last-child{margin:0}[id^=NotiflixNotifyWrap]>div.nx-with-callback{cursor:pointer}[id^=NotiflixNotifyWrap]>div.nx-with-icon{padding:8px;min-height:56px}[id^=NotiflixNotifyWrap]>div.nx-paused{cursor:auto}[id^=NotiflixNotifyWrap]>div.nx-notify-click-to-close{cursor:pointer}[id^=NotiflixNotifyWrap]>div.nx-with-close-button{padding:10px 36px 10px 12px}[id^=NotiflixNotifyWrap]>div.nx-with-icon.nx-with-close-button{padding:6px 36px 6px 6px}[id^=NotiflixNotifyWrap]>div>span.nx-message{cursor:inherit;font-weight:normal;font-family:inherit!important;word-break:break-all;word-break:break-word}[id^=NotiflixNotifyWrap]>div>span.nx-close-button{cursor:pointer;-webkit-transition:all .2s ease-in-out;-o-transition:all .2s ease-in-out;transition:all .2s ease-in-out;position:absolute;right:8px;top:0;bottom:0;margin:auto;color:inherit;width:20px;height:20px}[id^=NotiflixNotifyWrap]>div>span.nx-close-button:hover{-webkit-transform:rotate(90deg);transform:rotate(90deg)}[id^=NotiflixNotifyWrap]>div>span.nx-close-button>svg{position:absolute;width:16px;height:16px;right:2px;top:2px}[id^=NotiflixNotifyWrap]>div>.nx-message-icon{position:absolute;width:40px;height:40px;font-size:30px;line-height:40px;text-align:center;left:8px;top:0;bottom:0;margin:auto;border-radius:inherit}[id^=NotiflixNotifyWrap]>div>.nx-message-icon-fa.nx-message-icon-fa-shadow{color:inherit;background:rgba(0,0,0,.15);-webkit-box-shadow:inset 0 0 34px rgba(0,0,0,.2);box-shadow:inset 0 0 34px rgba(0,0,0,.2);text-shadow:0 0 10px rgba(0,0,0,.3)}[id^=NotiflixNotifyWrap]>div>span.nx-with-icon{position:relative;float:left;width:calc(100% - 40px);margin:0 0 0 40px;padding:0 0 0 10px;-webkit-box-sizing:border-box;box-sizing:border-box}[id^=NotiflixNotifyWrap]>div.nx-rtl-on>.nx-message-icon{left:auto;right:8px}[id^=NotiflixNotifyWrap]>div.nx-rtl-on>span.nx-with-icon{padding:0 10px 0 0;margin:0 40px 0 0}[id^=NotiflixNotifyWrap]>div.nx-rtl-on>span.nx-close-button{right:auto;left:8px}[id^=NotiflixNotifyWrap]>div.nx-with-icon.nx-with-close-button.nx-rtl-on{padding:6px 6px 6px 36px}[id^=NotiflixNotifyWrap]>div.nx-with-close-button.nx-rtl-on{padding:10px 12px 10px 36px}[id^=NotiflixNotifyOverlay].nx-with-animation,[id^=NotiflixNotifyWrap]>div.nx-with-animation.nx-fade{-webkit-animation:notify-animation-fade .3s ease-in-out 0s normal;animation:notify-animation-fade .3s ease-in-out 0s normal}@-webkit-keyframes notify-animation-fade{0%{opacity:0}100%{opacity:1}}@keyframes notify-animation-fade{0%{opacity:0}100%{opacity:1}}[id^=NotiflixNotifyWrap]>div.nx-with-animation.nx-zoom{-webkit-animation:notify-animation-zoom .3s ease-in-out 0s normal;animation:notify-animation-zoom .3s ease-in-out 0s normal}@-webkit-keyframes notify-animation-zoom{0%{-webkit-transform:scale(0);transform:scale(0)}50%{-webkit-transform:scale(1.05);transform:scale(1.05)}100%{-webkit-transform:scale(1);transform:scale(1)}}@keyframes notify-animation-zoom{0%{-webkit-transform:scale(0);transform:scale(0)}50%{-webkit-transform:scale(1.05);transform:scale(1.05)}100%{-webkit-transform:scale(1);transform:scale(1)}}[id^=NotiflixNotifyWrap]>div.nx-with-animation.nx-from-right{-webkit-animation:notify-animation-from-right .3s ease-in-out 0s normal;animation:notify-animation-from-right .3s ease-in-out 0s normal}@-webkit-keyframes notify-animation-from-right{0%{right:-300px;opacity:0}50%{right:8px;opacity:1}100%{right:0;opacity:1}}@keyframes notify-animation-from-right{0%{right:-300px;opacity:0}50%{right:8px;opacity:1}100%{right:0;opacity:1}}[id^=NotiflixNotifyWrap]>div.nx-with-animation.nx-from-left{-webkit-animation:notify-animation-from-left .3s ease-in-out 0s normal;animation:notify-animation-from-left .3s ease-in-out 0s normal}@-webkit-keyframes notify-animation-from-left{0%{left:-300px;opacity:0}50%{left:8px;opacity:1}100%{left:0;opacity:1}}@keyframes notify-animation-from-left{0%{left:-300px;opacity:0}50%{left:8px;opacity:1}100%{left:0;opacity:1}}[id^=NotiflixNotifyWrap]>div.nx-with-animation.nx-from-top{-webkit-animation:notify-animation-from-top .3s ease-in-out 0s normal;animation:notify-animation-from-top .3s ease-in-out 0s normal}@-webkit-keyframes notify-animation-from-top{0%{top:-50px;opacity:0}50%{top:8px;opacity:1}100%{top:0;opacity:1}}@keyframes notify-animation-from-top{0%{top:-50px;opacity:0}50%{top:8px;opacity:1}100%{top:0;opacity:1}}[id^=NotiflixNotifyWrap]>div.nx-with-animation.nx-from-bottom{-webkit-animation:notify-animation-from-bottom .3s ease-in-out 0s normal;animation:notify-animation-from-bottom .3s ease-in-out 0s normal}@-webkit-keyframes notify-animation-from-bottom{0%{bottom:-50px;opacity:0}50%{bottom:8px;opacity:1}100%{bottom:0;opacity:1}}@keyframes notify-animation-from-bottom{0%{bottom:-50px;opacity:0}50%{bottom:8px;opacity:1}100%{bottom:0;opacity:1}}[id^=NotiflixNotifyOverlay].nx-with-animation.nx-remove,[id^=NotiflixNotifyWrap]>div.nx-with-animation.nx-fade.nx-remove{opacity:0;-webkit-animation:notify-remove-fade .3s ease-in-out 0s normal;animation:notify-remove-fade .3s ease-in-out 0s normal}@-webkit-keyframes notify-remove-fade{0%{opacity:1}100%{opacity:0}}@keyframes notify-remove-fade{0%{opacity:1}100%{opacity:0}}[id^=NotiflixNotifyWrap]>div.nx-with-animation.nx-zoom.nx-remove{-webkit-transform:scale(0);transform:scale(0);-webkit-animation:notify-remove-zoom .3s ease-in-out 0s normal;animation:notify-remove-zoom .3s ease-in-out 0s normal}@-webkit-keyframes notify-remove-zoom{0%{-webkit-transform:scale(1);transform:scale(1)}50%{-webkit-transform:scale(1.05);transform:scale(1.05)}100%{-webkit-transform:scale(0);transform:scale(0)}}@keyframes notify-remove-zoom{0%{-webkit-transform:scale(1);transform:scale(1)}50%{-webkit-transform:scale(1.05);transform:scale(1.05)}100%{-webkit-transform:scale(0);transform:scale(0)}}[id^=NotiflixNotifyWrap]>div.nx-with-animation.nx-from-top.nx-remove{opacity:0;-webkit-animation:notify-remove-to-top .3s ease-in-out 0s normal;animation:notify-remove-to-top .3s ease-in-out 0s normal}@-webkit-keyframes notify-remove-to-top{0%{top:0;opacity:1}50%{top:8px;opacity:1}100%{top:-50px;opacity:0}}@keyframes notify-remove-to-top{0%{top:0;opacity:1}50%{top:8px;opacity:1}100%{top:-50px;opacity:0}}[id^=NotiflixNotifyWrap]>div.nx-with-animation.nx-from-right.nx-remove{opacity:0;-webkit-animation:notify-remove-to-right .3s ease-in-out 0s normal;animation:notify-remove-to-right .3s ease-in-out 0s normal}@-webkit-keyframes notify-remove-to-right{0%{right:0;opacity:1}50%{right:8px;opacity:1}100%{right:-300px;opacity:0}}@keyframes notify-remove-to-right{0%{right:0;opacity:1}50%{right:8px;opacity:1}100%{right:-300px;opacity:0}}[id^=NotiflixNotifyWrap]>div.nx-with-animation.nx-from-bottom.nx-remove{opacity:0;-webkit-animation:notify-remove-to-bottom .3s ease-in-out 0s normal;animation:notify-remove-to-bottom .3s ease-in-out 0s normal}@-webkit-keyframes notify-remove-to-bottom{0%{bottom:0;opacity:1}50%{bottom:8px;opacity:1}100%{bottom:-50px;opacity:0}}@keyframes notify-remove-to-bottom{0%{bottom:0;opacity:1}50%{bottom:8px;opacity:1}100%{bottom:-50px;opacity:0}}[id^=NotiflixNotifyWrap]>div.nx-with-animation.nx-from-left.nx-remove{opacity:0;-webkit-animation:notify-remove-to-left .3s ease-in-out 0s normal;animation:notify-remove-to-left .3s ease-in-out 0s normal}@-webkit-keyframes notify-remove-to-left{0%{left:0;opacity:1}50%{left:8px;opacity:1}100%{left:-300px;opacity:0}}@keyframes notify-remove-to-left{0%{left:0;opacity:1}50%{left:8px;opacity:1}100%{left:-300px;opacity:0}}'},h=0,d=function(a,u,d,p){if(!c("body"))return!1;t||f.Notify.init({});var m=l(!0,t,{});if("object"==typeof d&&!Array.isArray(d)||"object"==typeof p&&!Array.isArray(p)){var g={};"object"==typeof d?g=d:"object"==typeof p&&(g=p),t=l(!0,t,g)}var y,v,w=t[a.toLocaleLowerCase("en")];h++,"string"!=typeof u&&(u="Notiflix "+a),t.plainText&&(y=u,(v=e.document.createElement("div")).innerHTML=y,u=v.textContent||v.innerText||""),!t.plainText&&u.length>t.messageMaxLength&&(t=l(!0,t,{closeButton:!0,messageMaxLength:150}),u='Possible HTML Tags Error: The "plainText" option is "false" and the notification content length is more than the "messageMaxLength" option.'),u.length>t.messageMaxLength&&(u=u.substring(0,t.messageMaxLength)+"..."),"shadow"===t.fontAwesomeIconStyle&&(w.fontAwesomeIconColor=w.background),t.cssAnimation||(t.cssAnimationDuration=0);var b=e.document.getElementById(o.wrapID)||e.document.createElement("div");if(b.id=o.wrapID,b.style.width=t.width,b.style.zIndex=t.zindex,b.style.opacity=t.opacity,"center-center"===t.position?(b.style.left=t.distance,b.style.top=t.distance,b.style.right=t.distance,b.style.bottom=t.distance,b.style.margin="auto",b.classList.add("nx-flex-center-center"),b.style.maxHeight="calc((100vh - "+t.distance+") - "+t.distance+")",b.style.display="flex",b.style.flexWrap="wrap",b.style.flexDirection="column",b.style.justifyContent="center",b.style.alignItems="center",b.style.pointerEvents="none"):"center-top"===t.position?(b.style.left=t.distance,b.style.right=t.distance,b.style.top=t.distance,b.style.bottom="auto",b.style.margin="auto"):"center-bottom"===t.position?(b.style.left=t.distance,b.style.right=t.distance,b.style.bottom=t.distance,b.style.top="auto",b.style.margin="auto"):"right-bottom"===t.position?(b.style.right=t.distance,b.style.bottom=t.distance,b.style.top="auto",b.style.left="auto"):"left-top"===t.position?(b.style.left=t.distance,b.style.top=t.distance,b.style.right="auto",b.style.bottom="auto"):"left-bottom"===t.position?(b.style.left=t.distance,b.style.bottom=t.distance,b.style.top="auto",b.style.right="auto"):(b.style.right=t.distance,b.style.top=t.distance,b.style.left="auto",b.style.bottom="auto"),t.backOverlay){var T=e.document.getElementById(o.overlayID)||e.document.createElement("div");T.id=o.overlayID,T.style.width="100%",T.style.height="100%",T.style.position="fixed",T.style.zIndex=t.zindex-1,T.style.left=0,T.style.top=0,T.style.right=0,T.style.bottom=0,T.style.background=w.backOverlayColor||t.backOverlayColor,T.className=t.cssAnimation?"nx-with-animation":"",T.style.animationDuration=t.cssAnimation?t.cssAnimationDuration+"ms":"",e.document.getElementById(o.overlayID)||e.document.body.appendChild(T)}e.document.getElementById(o.wrapID)||e.document.body.appendChild(b);var _=e.document.createElement("div");_.id=t.ID+"-"+h,_.className=t.className+" "+w.childClassName+" "+(t.cssAnimation?"nx-with-animation":"")+" "+(t.useIcon?"nx-with-icon":"")+" nx-"+t.cssAnimationStyle+" "+(t.closeButton&&"function"!=typeof d?"nx-with-close-button":"")+" "+("function"==typeof d?"nx-with-callback":"")+" "+(t.clickToClose?"nx-notify-click-to-close":""),_.style.fontSize=t.fontSize,_.style.color=w.textColor,_.style.background=w.background,_.style.borderRadius=t.borderRadius,_.style.pointerEvents="all",t.rtl&&(_.setAttribute("dir","rtl"),_.classList.add("nx-rtl-on")),_.style.fontFamily='"'+t.fontFamily+'", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif',t.cssAnimation&&(_.style.animationDuration=t.cssAnimationDuration+"ms");var I="";if(t.closeButton&&"function"!=typeof d&&(I='<span class="nx-close-button"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"><g><path fill="'+w.notiflixIconColor+'" d="M0.38 2.19l7.8 7.81 -7.8 7.81c-0.51,0.5 -0.51,1.31 -0.01,1.81 0.25,0.25 0.57,0.38 0.91,0.38 0.34,0 0.67,-0.14 0.91,-0.38l7.81 -7.81 7.81 7.81c0.24,0.24 0.57,0.38 0.91,0.38 0.34,0 0.66,-0.14 0.9,-0.38 0.51,-0.5 0.51,-1.31 0,-1.81l-7.81 -7.81 7.81 -7.81c0.51,-0.5 0.51,-1.31 0,-1.82 -0.5,-0.5 -1.31,-0.5 -1.81,0l-7.81 7.81 -7.81 -7.81c-0.5,-0.5 -1.31,-0.5 -1.81,0 -0.51,0.51 -0.51,1.32 0,1.82z"/></g></svg></span>'),t.useIcon)if(t.useFontAwesome)_.innerHTML='<i style="color:'+w.fontAwesomeIconColor+"; font-size:"+t.fontAwesomeIconSize+';" class="nx-message-icon nx-message-icon-fa '+w.fontAwesomeClassName+" "+("shadow"===t.fontAwesomeIconStyle?"nx-message-icon-fa-shadow":"nx-message-icon-fa-basic")+'"></i><span class="nx-message nx-with-icon">'+u+"</span>"+(t.closeButton?I:"");else{var E="";a===n?E='<svg class="nx-message-icon" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40"><g><path fill="'+w.notiflixIconColor+'" d="M20 0c11.03,0 20,8.97 20,20 0,11.03 -8.97,20 -20,20 -11.03,0 -20,-8.97 -20,-20 0,-11.03 8.97,-20 20,-20zm0 37.98c9.92,0 17.98,-8.06 17.98,-17.98 0,-9.92 -8.06,-17.98 -17.98,-17.98 -9.92,0 -17.98,8.06 -17.98,17.98 0,9.92 8.06,17.98 17.98,17.98zm-2.4 -13.29l11.52 -12.96c0.37,-0.41 1.01,-0.45 1.42,-0.08 0.42,0.37 0.46,1 0.09,1.42l-12.16 13.67c-0.19,0.22 -0.46,0.34 -0.75,0.34 -0.23,0 -0.45,-0.07 -0.63,-0.22l-7.6 -6.07c-0.43,-0.35 -0.5,-0.99 -0.16,-1.42 0.35,-0.43 0.99,-0.5 1.42,-0.16l6.85 5.48z"/></g></svg>':a===i?E='<svg class="nx-message-icon" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40"><g><path fill="'+w.notiflixIconColor+'" d="M20 0c11.03,0 20,8.97 20,20 0,11.03 -8.97,20 -20,20 -11.03,0 -20,-8.97 -20,-20 0,-11.03 8.97,-20 20,-20zm0 37.98c9.92,0 17.98,-8.06 17.98,-17.98 0,-9.92 -8.06,-17.98 -17.98,-17.98 -9.92,0 -17.98,8.06 -17.98,17.98 0,9.92 8.06,17.98 17.98,17.98zm1.42 -17.98l6.13 6.12c0.39,0.4 0.39,1.04 0,1.43 -0.19,0.19 -0.45,0.29 -0.71,0.29 -0.27,0 -0.53,-0.1 -0.72,-0.29l-6.12 -6.13 -6.13 6.13c-0.19,0.19 -0.44,0.29 -0.71,0.29 -0.27,0 -0.52,-0.1 -0.71,-0.29 -0.39,-0.39 -0.39,-1.03 0,-1.43l6.13 -6.12 -6.13 -6.13c-0.39,-0.39 -0.39,-1.03 0,-1.42 0.39,-0.39 1.03,-0.39 1.42,0l6.13 6.12 6.12 -6.12c0.4,-0.39 1.04,-0.39 1.43,0 0.39,0.39 0.39,1.03 0,1.42l-6.13 6.13z"/></g></svg>':a===s?E='<svg class="nx-message-icon" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40"><g><path fill="'+w.notiflixIconColor+'" d="M21.91 3.48l17.8 30.89c0.84,1.46 -0.23,3.25 -1.91,3.25l-35.6 0c-1.68,0 -2.75,-1.79 -1.91,-3.25l17.8 -30.89c0.85,-1.47 2.97,-1.47 3.82,0zm16.15 31.84l-17.8 -30.89c-0.11,-0.2 -0.41,-0.2 -0.52,0l-17.8 30.89c-0.12,0.2 0.05,0.4 0.26,0.4l35.6 0c0.21,0 0.38,-0.2 0.26,-0.4zm-19.01 -4.12l0 -1.05c0,-0.53 0.42,-0.95 0.95,-0.95 0.53,0 0.95,0.42 0.95,0.95l0 1.05c0,0.53 -0.42,0.95 -0.95,0.95 -0.53,0 -0.95,-0.42 -0.95,-0.95zm0 -4.66l0 -13.39c0,-0.52 0.42,-0.95 0.95,-0.95 0.53,0 0.95,0.43 0.95,0.95l0 13.39c0,0.53 -0.42,0.96 -0.95,0.96 -0.53,0 -0.95,-0.43 -0.95,-0.96z"/></g></svg>':a===r&&(E='<svg class="nx-message-icon" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40"><g><path fill="'+w.notiflixIconColor+'" d="M20 0c11.03,0 20,8.97 20,20 0,11.03 -8.97,20 -20,20 -11.03,0 -20,-8.97 -20,-20 0,-11.03 8.97,-20 20,-20zm0 37.98c9.92,0 17.98,-8.06 17.98,-17.98 0,-9.92 -8.06,-17.98 -17.98,-17.98 -9.92,0 -17.98,8.06 -17.98,17.98 0,9.92 8.06,17.98 17.98,17.98zm-0.99 -23.3c0,-0.54 0.44,-0.98 0.99,-0.98 0.55,0 0.99,0.44 0.99,0.98l0 15.86c0,0.55 -0.44,0.99 -0.99,0.99 -0.55,0 -0.99,-0.44 -0.99,-0.99l0 -15.86zm0 -5.22c0,-0.55 0.44,-0.99 0.99,-0.99 0.55,0 0.99,0.44 0.99,0.99l0 1.09c0,0.54 -0.44,0.99 -0.99,0.99 -0.55,0 -0.99,-0.45 -0.99,-0.99l0 -1.09z"/></g></svg>'),_.innerHTML=E+'<span class="nx-message nx-with-icon">'+u+"</span>"+(t.closeButton?I:"")}else _.innerHTML='<span class="nx-message">'+u+"</span>"+(t.closeButton?I:"");if("left-bottom"===t.position||"right-bottom"===t.position){var k=e.document.getElementById(o.wrapID);k.insertBefore(_,k.firstChild)}else e.document.getElementById(o.wrapID).appendChild(_);var S=e.document.getElementById(_.id);if(S){var C,N,A=function(){S.classList.add("nx-remove");var t=e.document.getElementById(o.overlayID);t&&b.childElementCount<=0&&t.classList.add("nx-remove"),clearTimeout(C)},x=function(){if(S&&null!==S.parentNode&&S.parentNode.removeChild(S),b.childElementCount<=0&&null!==b.parentNode){b.parentNode.removeChild(b);var t=e.document.getElementById(o.overlayID);t&&null!==t.parentNode&&t.parentNode.removeChild(t)}clearTimeout(N)};if(t.closeButton&&"function"!=typeof d&&e.document.getElementById(_.id).querySelector("span.nx-close-button").addEventListener("click",(function(){A();var e=setTimeout((function(){x(),clearTimeout(e)}),t.cssAnimationDuration)})),("function"==typeof d||t.clickToClose)&&S.addEventListener("click",(function(){"function"==typeof d&&d(),A();var e=setTimeout((function(){x(),clearTimeout(e)}),t.cssAnimationDuration)})),!t.closeButton&&"function"!=typeof d){var L=function(){C=setTimeout((function(){A()}),t.timeout),N=setTimeout((function(){x()}),t.timeout+t.cssAnimationDuration)};L(),t.pauseOnHover&&(S.addEventListener("mouseenter",(function(){S.classList.add("nx-paused"),clearTimeout(C),clearTimeout(N)})),S.addEventListener("mouseleave",(function(){S.classList.remove("nx-paused"),L()})))}}if(t.showOnlyTheLastOne&&h>0)for(var D=e.document.querySelectorAll("[id^="+t.ID+"-]:not([id="+t.ID+"-"+h+"])"),R=0;R<D.length;R++){var P=D[R];null!==P.parentNode&&P.parentNode.removeChild(P)}t=l(!0,t,m)},f={Notify:{init:function(n){t=l(!0,o,n),function(t,n){if(!c("head"))return!1;if(null!==t()&&!e.document.getElementById(n)){var i=e.document.createElement("style");i.id=n,i.innerHTML=t(),e.document.head.appendChild(i)}}(u,"NotiflixNotifyInternalCSS")},merge:function(e){if(!t)return a("You have to initialize the Notify module before call Merge function."),!1;t=l(!0,t,e)},success:function(e,t,i){d(n,e,t,i)},failure:function(e,t,n){d(i,e,t,n)},warning:function(e,t,n){d(s,e,t,n)},info:function(e,t,n){d(r,e,t,n)}}};return"object"==typeof e.Notiflix?l(!0,e.Notiflix,{Notify:f.Notify}):{Notify:f.Notify}},"function"==typeof define&&define.amd?define([],(function(){return ut(lt)})):"object"==typeof dt?dt=ut(lt):lt.Notiflix=ut(lt);var ft,pt=s("3huUq");ft=new URL(s("kyEFX").resolve("dATrs"),import.meta.url).toString();const mt="https://image.tmdb.org/t/p/",gt="w500";class yt{getDataTrendMovies(e){return e.map((({poster_path:e,genre_ids:n,vote_average:i,title:s,id:r,release_date:o})=>{let a=mt+gt+e,c=Number.parseInt(o);const l=Ot(n);return e||(a=t(ft)),o||(c="Unknown date"),{imgUrl:a,genres:l,rating:i.toFixed(1),name:s,id:r,year:c}}))}getDataSelectedMovie(e){const{poster_path:t,genres:n,vote_average:i,vote_count:s,popularity:r,title:o,original_title:a,overview:c,release_date:l}=e;return{imgUrl:mt+gt+t,name:o,vote:i.toFixed(1),votes:s,popularity:r,originalTitle:a,about:c,year:Number.parseInt(l)}}}var vt=s("2sxQI");s("bTcpz");class wt{start(){St.backdropSpinner.classList.remove("is-hidden")}stop(){St.backdropSpinner.classList.add("is-hidden")}}const bt={firstPage:document.querySelector(".js-pagination--firstPage"),minus2Page:document.querySelector(".js-pagination--minus2Page"),minus1Page:document.querySelector(".js-pagination--minus1Page"),activPage:document.querySelector(".js-pagination--activPage"),plus1Page:document.querySelector(".js-pagination--plus1Page"),plus2Page:document.querySelector(".js-pagination--plus2Page"),lastPage:document.querySelector(".js-pagination--lastPage"),minusQuery:document.querySelector(".js-btn__minusQuery"),plusQuery:document.querySelector(".js-btn__plusQuery"),containerPage:document.querySelector(".js-pagination__page"),plusTen:document.querySelector(".btn-increment-ten"),minusTen:document.querySelector(".btn-decrement-ten"),containerPagAll:document.querySelector(".js-pagination")};bt.minusQuery.addEventListener("click",(async function e(t){It-=1,It>Et&&(It=1);const n=t.target,i=new Lt,s=new yt,r=St.searchForm.searchQuery.value.trim();if(i.query=r,i.page=It,0===It)return It=1,void n.blur();Tt.start();try{if(""!==r)return void await i.getSearchMovies().then((i=>{Et=i.total_pages,It>i.total_pages&&(It=2,e(t));const r=s.getDataTrendMovies(i.results),o=(0,pt.createMarkupFilmsList)(r);St.moviesList.innerHTML=o,n.blur(),_t(i)})).catch((e=>{Notify.failure(e)})).finally((()=>{Tt.stop()}));await i.getTrendMovie().then((i=>{Et=i.total_pages,It>i.total_pages&&(It=1,e(t));const r=s.getDataTrendMovies(i.results),o=(0,pt.createMarkupFilmsList)(r);St.moviesList.innerHTML=o,n.blur(),_t(i)})).catch((e=>{Notify.failure(e)})).finally((()=>{Tt.stop()}))}catch(e){Notify.failure(e)}})),bt.plusQuery.addEventListener("click",(async function e(t){It+=1,It>Et&&(It=1);const n=t.target,i=new Lt,s=new yt,r=St.searchForm.searchQuery.value.trim();i.query=r,i.page=It,Tt.start();try{if(""!==r)return void await i.getSearchMovies().then((i=>{n.blur(),_t(i),It>=i.total_pages&&bt.lastPage.classList.add("btn-active");const r=s.getDataTrendMovies(i.results),o=(0,pt.createMarkupFilmsList)(r);St.moviesList.innerHTML=o,bt.minusQuery.disabled=!1,Et=i.total_pages,It>i.total_pages&&(It=1,e(t))})).catch((e=>{Notify.failure(e)})).finally((()=>{Tt.stop()}));await i.getTrendMovie().then((i=>{n.blur(),Et=i.total_pages,It>i.total_pages&&(It=1,e(t)),It>=i.total_pages&&bt.lastPage.classList.add("btn-active");const r=s.getDataTrendMovies(i.results),o=(0,pt.createMarkupFilmsList)(r);St.moviesList.innerHTML=o,_t(i)})).catch((e=>{Notify.failure(e)})).finally((()=>{Tt.stop()}))}catch(e){Notify.failure(e)}})),bt.containerPage.addEventListener("click",kt),bt.minusTen.addEventListener("click",(async function(e){It-=10;const t=e.target;It<0&&(It=1);const n=new Lt,i=new yt,s=St.searchForm.searchQuery.value.trim();n.query=s,n.page=It,Tt.start();try{if(""!==s)return void await n.getSearchMovies().then((e=>{Et=e.total_pages;const n=i.getDataTrendMovies(e.results),s=(0,pt.createMarkupFilmsList)(n);St.moviesList.innerHTML=s,t.blur(),_t(e)})).catch((e=>{Notify.failure(e)})).finally((()=>{Tt.stop()}));await n.getTrendMovie().then((e=>{if(Et=e.total_pages,It<=0)return;const n=i.getDataTrendMovies(e.results),s=(0,pt.createMarkupFilmsList)(n);St.moviesList.innerHTML=s,t.blur(),_t(e)})).catch((e=>{Notify.failure(e)})).finally((()=>{Tt.stop()}))}catch(e){Notify.failure(e)}})),bt.plusTen.addEventListener("click",(async function(e){It+=10;const t=e.target;It>Et&&(It=Et);const n=St.searchForm.searchQuery.value.trim();movieAPI.query=n,movieAPI.page=It,Tt.start();try{if(""!==n)return void await movieAPI.getSearchMovies().then((e=>{if(Et=e.total_pages,It>e.total_pages)return;t.blur(),_t(e);const n=dataService.getDataTrendMovies(e.results),i=(0,pt.createMarkupFilmsList)(n);St.moviesList.innerHTML=i,bt.minusQuery.disabled=!1})).catch((e=>{Notify.failure(e)})).finally((()=>{Tt.stop()}));await movieAPI.getTrendMovie().then((e=>{Et=e.total_pages,e.total_pages||bt.containerPage.classList.add("visually-hidden");const n=dataService.getDataTrendMovies(e.results),i=(0,pt.createMarkupFilmsList)(n);St.moviesList.innerHTML=i,t.blur(),_t(e)})).catch((e=>{Notify.failure(e)})).finally((()=>{Tt.stop()}))}catch(e){Notify.failure(e)}})),bt.lastPage.addEventListener("click",kt),bt.firstPage.addEventListener("click",kt);const Tt=new wt;function _t(e){switch((0,vt.scrollTop)(),e.page){case 1:It=1,bt.firstPage.textContent=1,bt.plus2Page.classList.remove("btn-active"),bt.plus1Page.classList.remove("btn-active"),bt.minus1Page.classList.remove("btn-active"),bt.minus2Page.classList.remove("btn-active"),bt.firstPage.classList.remove("btn-active"),bt.lastPage.classList.remove("btn-active"),bt.activPage.classList.remove("btn-active"),bt.firstPage.classList.add("btn-active"),bt.lastPage.textContent=e.total_pages,bt.minus2Page.textContent=e.page+1,bt.minus1Page.textContent=e.page+2,bt.activPage.textContent=e.page+3,bt.plus1Page.textContent=e.page+4,bt.plus2Page.textContent=e.page+5;break;case 2:bt.firstPage.textContent=1,bt.firstPage.classList.remove("btn-active"),bt.plus2Page.classList.remove("btn-active"),bt.plus1Page.classList.remove("btn-active"),bt.minus1Page.classList.remove("btn-active"),bt.firstPage.classList.remove("btn-active"),bt.lastPage.classList.remove("btn-active"),bt.activPage.classList.remove("btn-active"),bt.lastPage.textContent=e.total_pages,bt.minus2Page.textContent=e.page,bt.minus2Page.classList.add("btn-active"),bt.minus1Page.textContent=e.page+1,bt.activPage.textContent=e.page+2,bt.plus1Page.textContent=e.page+3,bt.plus2Page.textContent=e.page+4;break;case 3:bt.firstPage.textContent=1,bt.minus2Page.classList.remove("btn-active"),bt.plus2Page.classList.remove("btn-active"),bt.plus1Page.classList.remove("btn-active"),bt.firstPage.classList.remove("btn-active"),bt.lastPage.classList.remove("btn-active"),bt.activPage.classList.remove("btn-active"),bt.lastPage.textContent=e.total_pages,bt.minus2Page.textContent=e.page-1,bt.minus1Page.classList.add("btn-active"),bt.minus1Page.textContent=e.page,bt.activPage.textContent=e.page+1,bt.plus1Page.textContent=e.page+2,bt.plus2Page.textContent=e.page+3;break;case 4:bt.firstPage.textContent=1,bt.minus1Page.classList.remove("btn-active"),bt.plus2Page.classList.remove("btn-active"),bt.plus1Page.classList.remove("btn-active"),bt.minus2Page.classList.remove("btn-active"),bt.firstPage.classList.remove("btn-active"),bt.activPage.classList.remove("btn-active"),bt.lastPage.textContent=e.total_pages,bt.minus2Page.textContent=e.page-2,bt.activPage.classList.add("btn-active"),bt.minus1Page.textContent=e.page-1,bt.activPage.textContent=e.page,bt.plus1Page.textContent=e.page+1,bt.plus2Page.textContent=e.page+2;break;case 5:bt.firstPage.textContent=1,bt.activPage.classList.remove("btn-active"),bt.plus2Page.classList.remove("btn-active"),bt.minus1Page.classList.remove("btn-active"),bt.minus2Page.classList.remove("btn-active"),bt.firstPage.classList.remove("btn-active"),bt.lastPage.textContent=e.total_pages,bt.minus2Page.textContent=e.page-3,bt.plus1Page.classList.add("btn-active"),bt.minus1Page.textContent=e.page-2,bt.activPage.textContent=e.page-1,bt.plus1Page.textContent=e.page,bt.plus2Page.textContent=e.page+1;break;case 6:bt.firstPage.textContent=1,bt.plus1Page.classList.remove("btn-active"),bt.minus1Page.classList.remove("btn-active"),bt.minus2Page.classList.remove("btn-active"),bt.firstPage.classList.remove("btn-active"),bt.activPage.classList.remove("btn-active"),bt.lastPage.textContent=e.total_pages,bt.minus2Page.textContent=e.page-4,bt.plus2Page.classList.add("btn-active"),bt.minus1Page.textContent=e.page-3,bt.activPage.textContent=e.page-2,bt.plus1Page.textContent=e.page-1,bt.plus2Page.textContent=e.page;break;case e.total_pages-2:bt.firstPage.textContent=1,bt.plus2Page.classList.remove("btn-active"),bt.minus1Page.classList.remove("btn-active"),bt.minus2Page.classList.remove("btn-active"),bt.lastPage.classList.remove("btn-active"),bt.firstPage.classList.remove("btn-active"),bt.activPage.classList.remove("btn-active"),bt.lastPage.textContent=e.total_pages,bt.minus2Page.textContent=e.page-3,bt.plus1Page.classList.add("btn-active"),bt.minus1Page.textContent=e.page-2,bt.activPage.textContent=e.page-1,bt.plus1Page.textContent=e.page,bt.plus2Page.textContent=e.page+1;break;case e.total_pages-1:bt.firstPage.textContent=1,bt.plus1Page.classList.remove("btn-active"),bt.minus1Page.classList.remove("btn-active"),bt.minus2Page.classList.remove("btn-active"),bt.lastPage.classList.remove("btn-active"),bt.firstPage.classList.remove("btn-active"),bt.activPage.classList.remove("btn-active"),bt.lastPage.textContent=e.total_pages,bt.minus2Page.textContent=e.page-4,bt.plus2Page.classList.add("btn-active"),bt.minus1Page.textContent=e.page-3,bt.activPage.textContent=e.page-2,bt.plus1Page.textContent=e.page-1,bt.plus2Page.textContent=e.page;break;case e.total_pages:bt.firstPage.textContent=1,bt.plus2Page.classList.remove("btn-active"),bt.plus1Page.classList.remove("btn-active"),bt.minus1Page.classList.remove("btn-active"),bt.minus2Page.classList.remove("btn-active"),bt.firstPage.classList.remove("btn-active"),bt.activPage.classList.remove("btn-active"),bt.lastPage.textContent=e.total_pages,bt.minus2Page.textContent=e.page-5,bt.lastPage.classList.add("btn-active"),bt.minus1Page.textContent=e.page-4,bt.activPage.textContent=e.page-3,bt.plus1Page.textContent=e.page-2,bt.plus2Page.textContent=e.page-1;break;default:bt.firstPage.textContent=1,bt.plus2Page.classList.remove("btn-active"),bt.plus1Page.classList.remove("btn-active"),bt.minus1Page.classList.remove("btn-active"),bt.minus2Page.classList.remove("btn-active"),bt.firstPage.classList.remove("btn-active"),bt.lastPage.classList.remove("btn-active"),bt.activPage.classList.add("btn-active"),bt.plusQuery.classList.remove("btn-active"),bt.minusQuery.classList.remove("btn-active"),bt.lastPage.textContent=e.total_pages,bt.minus2Page.textContent=e.page-2,bt.minus1Page.textContent=e.page-1,bt.activPage.textContent=e.page,bt.plus1Page.textContent=e.page+1,bt.plus2Page.textContent=e.page+2}switch(e.total_pages){case 1:bt.plus2Page.classList.add("visually-hidden"),bt.plus1Page.classList.add("visually-hidden"),bt.minus1Page.classList.add("visually-hidden"),bt.minus2Page.classList.add("visually-hidden"),bt.lastPage.classList.add("visually-hidden"),bt.activPage.classList.add("visually-hidden"),bt.minusTen.classList.add("visually-hidden"),bt.plusTen.classList.add("visually-hidden"),bt.minusQuery.classList.add("visually-hidden"),bt.plusQuery.classList.add("visually-hidden");break;case 2:bt.plus2Page.classList.add("visually-hidden"),bt.plus1Page.classList.add("visually-hidden"),bt.minus1Page.classList.add("visually-hidden"),bt.minus2Page.classList.remove("visually-hidden"),bt.lastPage.classList.add("visually-hidden"),bt.activPage.classList.add("visually-hidden"),bt.minusTen.classList.add("visually-hidden"),bt.plusTen.classList.add("visually-hidden"),bt.minusQuery.classList.add("visually-hidden"),bt.plusQuery.classList.add("visually-hidden");break;case 3:bt.plus2Page.classList.add("visually-hidden"),bt.plus1Page.classList.add("visually-hidden"),bt.minus1Page.classList.remove("visually-hidden"),bt.minus2Page.classList.remove("visually-hidden"),bt.lastPage.classList.add("visually-hidden"),bt.activPage.classList.add("visually-hidden"),bt.minusTen.classList.add("visually-hidden"),bt.plusTen.classList.add("visually-hidden"),bt.minusQuery.classList.add("visually-hidden"),bt.plusQuery.classList.add("visually-hidden");break;case 4:bt.plus2Page.classList.add("visually-hidden"),bt.plus1Page.classList.add("visually-hidden"),bt.minus1Page.classList.remove("visually-hidden"),bt.minus2Page.classList.remove("visually-hidden"),bt.lastPage.classList.remove("visually-hidden"),bt.activPage.classList.add("visually-hidden"),bt.minusTen.classList.add("visually-hidden"),bt.plusTen.classList.add("visually-hidden"),bt.minusQuery.classList.remove("visually-hidden"),bt.plusQuery.classList.remove("visually-hidden");break;case 5:bt.plus2Page.classList.add("visually-hidden"),bt.plus1Page.classList.add("visually-hidden"),bt.minus1Page.classList.remove("visually-hidden"),bt.minus2Page.classList.remove("visually-hidden"),bt.lastPage.classList.remove("visually-hidden"),bt.activPage.classList.remove("visually-hidden"),bt.minusTen.classList.add("visually-hidden"),bt.plusTen.classList.add("visually-hidden"),bt.minusQuery.classList.remove("visually-hidden"),bt.plusQuery.classList.remove("visually-hidden");break;case 6:bt.plus2Page.classList.add("visually-hidden"),bt.plus1Page.classList.remove("visually-hidden"),bt.minus1Page.classList.remove("visually-hidden"),bt.minus2Page.classList.remove("visually-hidden"),bt.lastPage.classList.remove("visually-hidden"),bt.activPage.classList.remove("visually-hidden"),bt.minusTen.classList.add("visually-hidden"),bt.plusTen.classList.add("visually-hidden"),bt.minusQuery.classList.remove("visually-hidden"),bt.plusQuery.classList.remove("visually-hidden");break;default:bt.plus2Page.classList.remove("visually-hidden"),bt.plus1Page.classList.remove("visually-hidden"),bt.minus1Page.classList.remove("visually-hidden"),bt.minus2Page.classList.remove("visually-hidden"),bt.lastPage.classList.remove("visually-hidden"),bt.activPage.classList.remove("visually-hidden"),bt.minusQuery.classList.remove("visually-hidden"),bt.plusQuery.classList.remove("visually-hidden"),bt.minusTen.classList.remove("visually-hidden"),bt.plusTen.classList.remove("visually-hidden")}}let It=1,Et=100;async function kt(e){const t=e.target;if(It=Number(t.textContent),Tt.start(),"BUTTON"===t.nodeName)try{const e=new Lt,n=new yt,i=St.searchForm.searchQuery.value.trim();if(e.query=i,e.page=It,""!==i)return void await e.getSearchMovies().then((e=>{Et=e.total_pages;const i=n.getDataTrendMovies(e.results),s=(0,pt.createMarkupFilmsList)(i);St.moviesList.innerHTML=s,t.blur(),_t(e)})).catch((e=>{Notify.failure(e)})).finally((()=>{Tt.stop()}));await e.getTrendMovie().then((e=>{Et=e.total_pages;const i=n.getDataTrendMovies(e.results),s=(0,pt.createMarkupFilmsList)(i);St.moviesList.innerHTML=s,t.blur(),_t(e)})).catch((e=>{Notify.failure(e)})).finally((()=>{Tt.stop()}))}catch(e){Notify.failure(e)}}const St={moviesList:document.querySelector(".js-films-list"),firstPage:document.querySelector(".js-pagination--firstPage"),minus2Page:document.querySelector(".js-pagination--minus2Page"),minus1Page:document.querySelector(".js-pagination--minus1Page"),activPage:document.querySelector(".js-pagination--activPage"),plus1Page:document.querySelector(".js-pagination--plus1Page"),plus2Page:document.querySelector(".js-pagination--plus2Page"),lastPage:document.querySelector(".js-pagination--lastPage"),minusQuery:document.querySelector(".js-btn__minusQuery"),plusQuery:document.querySelector(".js-btn__plusQuery"),containerPage:document.querySelector(".js-pagination__page"),plusTen:document.querySelector(".btn-increment-ten"),minusTen:document.querySelector(".btn-decrement-ten"),containerPagAll:document.querySelector(".js-pagination"),backdrop:document.querySelector(".backdrop"),modalMovies:document.querySelector("[data-modal]"),openModalCard:document.querySelector("[data-modal-open]"),closeModalBtn:document.querySelector("[data-modal-close]"),trailerBtn:document.querySelector(".trailer-btn"),openTeamModalBtn:document.querySelector("[data-modal-open-team]"),closeTeamModalBtn:document.querySelector("[data-modal-close-team]"),backdropFooter:document.querySelector(".backdrop-footer"),openRegistrModalBtn:document.querySelector("[data-modal-open-registr]"),closeRegistrModalBtn:document.querySelector("[data-modal-close-registr]"),backdropRegistr:document.querySelector(".backdrop-registr"),searchForm:document.querySelector(".header__form"),searchErrorImg:document.querySelector(".films__error-img"),noMoviesNotification:document.querySelector(".films__no-movies-notification"),notCorrectNotification:document.querySelector(".films__not-correct-notification"),backdropSpinner:document.querySelector(".backdrop-spin"),spinner:document.querySelector(".js-spinner"),signInButtonElement:document.querySelector(".js-sign-in"),signOutButtonElement:document.querySelector(".js-sign-out"),userPicElement:document.getElementById("user-pic"),userNameElement:document.getElementById("user-name"),userInfoElement:document.getElementById("user-container"),signInWithEmail:document.querySelector("[data-modal-sign-in-email]"),signInWithGoogle:document.querySelector("[data-modal-sign-in-google]")};var Ct=new WeakMap,Nt=new WeakMap,At=new WeakMap,xt=new WeakMap;class Lt{async getTrendMovie(){try{const{data:e}=await ht.default.get(`${st(this,Ct)}/trending/movie/day?api_key=${st(this,Nt)}&page=${st(this,xt)}`);return St.containerPagAll.classList.remove("visually-hidden"),e}catch(e){St.containerPagAll.classList.add("visually-hidden"),console.error(e)}}async getGenres(){try{const{data:e}=await ht.default.get(`${st(this,Ct)}/genre/movie/list?api_key=${st(this,Nt)}&language=en-US`);return e.genres}catch(e){console.error(e)}}async getSearchMovies(){try{return(await ht.default.get(`${st(this,Ct)}/search/movie?api_key=${st(this,Nt)}&query=${st(this,At)}&page=${st(this,xt)}`)).data}catch(e){St.containerPage.classList.add("visually-hidden"),dt.Notify.failure(e)}}resetPage(){ct(this,xt,1)}get query(){return st(this,At)}set query(e){ct(this,At,e)}get page(){return st(this,xt)}set page(e){ct(this,xt,e)}constructor(){ot(this,Ct,{writable:!0,value:"https://api.themoviedb.org/3"}),ot(this,Nt,{writable:!0,value:"d03712107dcdd723f1173c5ee2c0d8c1"}),ot(this,At,{writable:!0,value:""}),ot(this,xt,{writable:!0,value:1})}}pt=s("3huUq");const Dt=new yt,Rt=new Lt,Pt=new wt;function Ot(e){const t=[];return e.find((e=>{(function(){try{const e=localStorage.getItem("GENRES");return null===e?[]:JSON.parse(e)}catch(e){console.error("Get state error: ",e.message)}})().forEach((n=>{n.id===e&&t.push(n.name)}))})),t}pt=s("3huUq");const Mt=new wt,Ut=new yt,Ft=new Lt;St.searchForm.addEventListener("submit",(function(e){e.preventDefault();const t=e.currentTarget.elements.searchQuery.value.trim();if(St.notCorrectNotification.classList.remove("films__not-correct-notification-show"),St.noMoviesNotification.classList.remove("films__no-movies-notification-show"),St.noMoviesNotification.classList.add("visually-hidden"),!t)return void St.notCorrectNotification.classList.add("films__not-correct-notification-show");St.moviesList.innerHTML="",Ft.query=t,Mt.start(),Ft.getSearchMovies().then((e=>{if(St.notCorrectNotification.classList.remove("films__not-correct-notification-show"),St.noMoviesNotification.classList.remove("films__no-movies-notification-show"),St.searchErrorImg.classList.add("visually-hidden"),0===e.results.length)return St.searchErrorImg.classList.remove("visually-hidden"),St.noMoviesNotification.classList.add("films__no-movies-notification-show"),St.noMoviesNotification.classList.remove("visually-hidden"),void St.containerPagAll.classList.add("visually-hidden");St.containerPagAll.classList.remove("visually-hidden"),_t(e);const t=Ut.getDataTrendMovies(e.results),n=(0,pt.createMarkupFilmsList)(t);St.moviesList.innerHTML=n})).catch((e=>dt.Notify.failure(e))).finally((()=>{Mt.stop()}))})),s("bTcpz"),s("6HA5D");var Vt=s("bTcpz");function jt(){St.backdropRegistr.classList.add("is-hidden"),window.removeEventListener("keydown",Bt),window.onscroll=function(){window.scrollTo()}}function Bt(e){"Escape"===e.code&&jt()}St.openRegistrModalBtn.addEventListener("click",(function(){St.backdropRegistr.classList.remove("is-hidden"),window.addEventListener("keydown",Bt),(0,Vt.bodyScrollOff)()})),St.closeRegistrModalBtn.addEventListener("click",jt),St.backdropRegistr.addEventListener("click",(function(e){e.currentTarget===e.target&&jt()})),s("2sxQI");function qt(e,t){var n={};for(var i in e)Object.prototype.hasOwnProperty.call(e,i)&&t.indexOf(i)<0&&(n[i]=e[i]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var s=0;for(i=Object.getOwnPropertySymbols(e);s<i.length;s++)t.indexOf(i[s])<0&&Object.prototype.propertyIsEnumerable.call(e,i[s])&&(n[i[s]]=e[i[s]])}return n}Object.create;Object.create;function zt(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Ht=zt,Wt=new U("auth","Firebase",{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}),$t=new oe("@firebase/auth");function Kt(e,...t){$t.logLevel<=ee.ERROR&&$t.error(`Auth (${Fe}): ${e}`,...t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _n(e){return 1e3*Number(e)}function In(e){const[t,n,i]=e.split(".");if(void 0===t||void 0===n||void 0===i)return Kt("JWT malformed, contained fewer than 3 sections"),null;try{const e=I(n);return e?JSON.parse(e):(Kt("Failed to decode base64 JWT payload"),null)}catch(e){return Kt("Caught error parsing JWT payload as JSON",null==e?void 0:e.toString()),null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function En(e,t,n=!1){if(n)return t;try{return await t}catch(t){throw t instanceof M&&function({code:e}){return"auth/user-disabled"===e||"auth/user-token-expired"===e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sn{_initializeTime(){this.lastSignInTime=Tn(this.lastLoginAt),this.creationTime=Tn(this.createdAt)}_copy(e){this.createdAt=e.createdAt,this.lastLoginAt=e.lastLoginAt,this._initializeTime()}toJSON(){return{createdAt:this.createdAt,lastLoginAt:this.lastLoginAt}}constructor(e,t){this.createdAt=e,this.lastLoginAt=t,this._initializeTime()}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
class Nn{get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){Zt(e.idToken,"internal-error"),Zt(void 0!==e.idToken,"internal-error"),Zt(void 0!==e.refreshToken,"internal-error");const t="expiresIn"in e&&void 0!==e.expiresIn?Number(e.expiresIn):function(e){const t=In(e);return Zt(t,"internal-error"),Zt(void 0!==t.exp,"internal-error"),Zt(void 0!==t.iat,"internal-error"),Number(t.exp)-Number(t.iat)}(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}async getToken(e,t=!1){return Zt(!this.accessToken||this.refreshToken,e,"user-token-expired"),t||!this.accessToken||this.isExpired?this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null:this.accessToken}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:n,refreshToken:i,expiresIn:s}=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function An(e,t){Zt("string"==typeof e||void 0===e,"internal-error",{appName:t})}class xn{async getIdToken(e){const t=await En(this,this.stsTokenManager.getToken(this.auth,e));return Zt(t,this.auth,"internal-error"),this.accessToken!==t&&(this.accessToken=t,await this.auth._persistUserIfCurrent(this),this.auth._notifyListenersIfCurrent(this)),t}getIdTokenResult(e){return async function(e,t=!1){const n=G(e),i=await n.getIdToken(t),s=In(i);Zt(s&&s.exp&&s.auth_time&&s.iat,n.auth,"internal-error");const r="object"==typeof s.firebase?s.firebase:void 0,o=null==r?void 0:r.sign_in_provider;return{claims:s,token:i,authTime:Tn(_n(s.auth_time)),issuedAtTime:Tn(_n(s.iat)),expirationTime:Tn(_n(s.exp)),signInProvider:o||null,signInSecondFactor:(null==r?void 0:r.sign_in_second_factor)||null}}(this,e)}reload(){return async function(e){const t=G(e);await Cn(t),await t.auth._persistUserIfCurrent(t),t.auth._notifyListenersIfCurrent(t)}(this)}_assign(e){this!==e&&(Zt(this.uid===e.uid,this.auth,"internal-error"),this.displayName=e.displayName,this.photoURL=e.photoURL,this.email=e.email,this.emailVerified=e.emailVerified,this.phoneNumber=e.phoneNumber,this.isAnonymous=e.isAnonymous,this.tenantId=e.tenantId,this.providerData=e.providerData.map((e=>Object.assign({},e))),this.metadata._copy(e.metadata),this.stsTokenManager._assign(e.stsTokenManager))}_clone(e){return new xn(Object.assign(Object.assign({},this),{auth:e,stsTokenManager:this.stsTokenManager._clone()}))}_onReload(e){Zt(!this.reloadListener,this.auth,"internal-error"),this.reloadListener=e,this.reloadUserInfo&&(this._notifyReloadListener(this.reloadUserInfo),this.reloadUserInfo=null)}_notifyReloadListener(e){this.reloadListener?this.reloadListener(e):this.reloadUserInfo=e}_startProactiveRefresh(){this.proactiveRefresh._start()}_stopProactiveRefresh(){this.proactiveRefresh._stop()}async _updateTokensIfNecessary(e,t=!1){let n=!1;e.idToken&&e.idToken!==this.stsTokenManager.accessToken&&(this.stsTokenManager.updateFromServerResponse(e),n=!0),t&&await Cn(this),await this.auth._persistUserIfCurrent(this),n&&this.auth._notifyListenersIfCurrent(this)}async delete(){const e=await this.getIdToken();return await En(this,async function(e,t){return mn(e,"POST","/v1/accounts:delete",t)}(this.auth,{idToken:e})),this.stsTokenManager.clearRefreshToken(),this.auth.signOut()}toJSON(){return Object.assign(Object.assign({uid:this.uid,email:this.email||void 0,emailVerified:this.emailVerified,displayName:this.displayName||void 0,isAnonymous:this.isAnonymous,photoURL:this.photoURL||void 0,phoneNumber:this.phoneNumber||void 0,tenantId:this.tenantId||void 0,providerData:this.providerData.map((e=>Object.assign({},e))),stsTokenManager:this.stsTokenManager.toJSON(),_redirectEventId:this._redirectEventId},this.metadata.toJSON()),{apiKey:this.auth.config.apiKey,appName:this.auth.name})}get refreshToken(){return this.stsTokenManager.refreshToken||""}static _fromJSON(e,t){var n,i,s,r,o,a,c,l;const u=null!==(n=t.displayName)&&void 0!==n?n:void 0,h=null!==(i=t.email)&&void 0!==i?i:void 0,d=null!==(s=t.phoneNumber)&&void 0!==s?s:void 0,f=null!==(r=t.photoURL)&&void 0!==r?r:void 0,p=null!==(o=t.tenantId)&&void 0!==o?o:void 0,m=null!==(a=t._redirectEventId)&&void 0!==a?a:void 0,g=null!==(c=t.createdAt)&&void 0!==c?c:void 0,y=null!==(l=t.lastLoginAt)&&void 0!==l?l:void 0,{uid:v,emailVerified:w,isAnonymous:b,providerData:T,stsTokenManager:_}=t;Zt(v&&_,e,"internal-error");const I=Nn.fromJSON(this.name,_);Zt("string"==typeof v,e,"internal-error"),An(u,e.name),An(h,e.name),Zt("boolean"==typeof w,e,"internal-error"),Zt("boolean"==typeof b,e,"internal-error"),An(d,e.name),An(f,e.name),An(p,e.name),An(m,e.name),An(g,e.name),An(y,e.name);const E=new xn({uid:v,auth:e,email:h,emailVerified:w,displayName:u,isAnonymous:b,photoURL:f,phoneNumber:d,tenantId:p,stsTokenManager:I,createdAt:g,lastLoginAt:y});return T&&Array.isArray(T)&&(E.providerData=T.map((e=>Object.assign({},e)))),m&&(E._redirectEventId=m),E}static async _fromIdTokenResponse(e,t,n=!1){const i=new Nn;i.updateFromServerResponse(t);const s=new xn({uid:t.localId,auth:e,stsTokenManager:i,isAnonymous:n});return await Cn(s),s}constructor(e){var{uid:t,auth:n,stsTokenManager:i}=e,s=qt(e,["uid","auth","stsTokenManager"]);this.providerId="firebase",this.proactiveRefresh=new kn(this),this.reloadUserInfo=null,this.reloadListener=null,this.uid=t,this.auth=n,this.stsTokenManager=i,this.accessToken=i.accessToken,this.displayName=s.displayName||null,this.email=s.email||null,this.emailVerified=s.emailVerified||!1,this.phoneNumber=s.phoneNumber||null,this.photoURL=s.photoURL||null,this.isAnonymous=s.isAnonymous||!1,this.tenantId=s.tenantId||null,this.providerData=s.providerData?[...s.providerData]:[],this.metadata=new Sn(s.createdAt||void 0,s.lastLoginAt||void 0)}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function On(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Vn(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(Mn(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Bn(t))return"Blackberry";if(qn(t))return"Webos";if(Un(t))return"Safari";if((t.includes("chrome/")||Fn(t))&&!t.includes("edge/"))return"Chrome";if(jn(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function Mn(e=D()){return/firefox\//i.test(e)}function Un(e=D()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Fn(e=D()){return/crios\//i.test(e)}function Vn(e=D()){return/iemobile/i.test(e)}function jn(e=D()){return/android/i.test(e)}function Bn(e=D()){return/blackberry/i.test(e)}function qn(e=D()){return/webos/i.test(e)}function zn(e=D()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function Hn(){return P()&&10===document.documentMode}function Wn(e=D()){return zn(e)||jn(e)||qn(e)||Bn(e)||/windows phone/i.test(e)||Vn(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function $n(e,t=[]){let n;switch(e){case"Browser":n=On(D());break;case"Worker":n=`${On(D())}-${e}`;break;default:n=e}const i=t.length?t.join(","):"FirebaseCore-web";return`${n}/JsCore/${Fe}/${i}`}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function wi(e,t,n=!1){const i=await En(e,t._linkToIdToken(e.auth,await e.getIdToken()),n);return mi._forOperation(e,"link",i)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ii{_isAvailable(){try{return this.storage?(this.storage.setItem(_i,"1"),this.storage.removeItem(_i),Promise.resolve(!0)):Promise.resolve(!1)}catch(e){return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}constructor(e,t){this.storageRetriever=e,this.type=t}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Si extends Ii{_addListener(e,t){}_removeListener(e,t){}constructor(){super((()=>window.sessionStorage),"SESSION")}}Si.type="SESSION";const Ci=Si;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const $i="recaptcha";async function Ki(e,t,n){var i;const s=await n.verify();try{let r;if(Zt("string"==typeof s,e,"argument-error"),Zt(n.type===$i,e,"argument-error"),r="string"==typeof t?{phoneNumber:t}:t,"session"in r){const t=r.session;if("phoneNumber"in r){Zt("enroll"===t.type,e,"internal-error");const n=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _s=new ln(5e3,15e3),Is="__/auth/iframe",Es="emulator/auth/iframe",ks={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Ss=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Cs(e){const t=e.config;Zt(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?un(t,Es):`https://${e.config.authDomain}/${Is}`,i={apiKey:t.apiKey,appName:e.name,v:Fe},s=Ss.get(e.config.apiHost);s&&(i.eid=s);const r=e._getFrameworks();return r.length&&(i.fw=r.join(",")),`${n}?${q(i).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * limitations under the License.
 */
const Ns={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},As=500,xs=600,Ls="_blank",Ds="http://localhost";class Rs{close(){if(this.window)try{this.window.close()}catch(e){}}constructor(e){this.window=e,this.associatedEvent=null}}function Ps(e,t,n,i=As,s=xs){const r=Math.max((window.screen.availHeight-s)/2,0).toString(),o=Math.max((window.screen.availWidth-i)/2,0).toString();let a="";const c=Object.assign(Object.assign({},Ns),{width:i.toString(),height:s.toString(),top:r,left:o}),l=D().toLowerCase();n&&(a=Fn(l)?Ls:n),Mn(l)&&(t=t||Ds,c.scrollbars="yes");const u=Object.entries(c).reduce(((e,[t,n])=>`${e}${t}=${n},`),"");if(function(e=D()){var t;return zn(e)&&!!(null===(t=window.navigator)||void 0===t?void 0:t.standalone)}(l)&&"_self"!==a)return function(e,t){const n=document.createElement("a");n.href=e,n.target=t;const i=document.createEvent("MouseEvent");i.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(i)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
class El{static now(){return El.fromMillis(Date.now())}static fromDate(e){return El.fromMillis(e.getTime())}static fromMillis(e){const t=Math.floor(e/1e3),n=Math.floor(1e6*(e-1e3*t));return new El(t,n)}toDate(){return new Date(this.toMillis())}toMillis(){return 1e3*this.seconds+this.nanoseconds/1e6}_compareTo(e){return this.seconds===e.seconds?_l(this.nanoseconds,e.nanoseconds):_l(this.seconds,e.seconds)}isEqual(e){return e.seconds===this.seconds&&e.nanoseconds===this.nanoseconds}toString(){return"Timestamp(seconds="+this.seconds+", nanoseconds="+this.nanoseconds+")"}toJSON(){return{seconds:this.seconds,nanoseconds:this.nanoseconds}}valueOf(){const e=this.seconds- -62135596800;return String(e).padStart(12,"0")+"."+String(this.nanoseconds).padStart(9,"0")}constructor(e,t){if(this.seconds=e,this.nanoseconds=t,t<0)throw new ul(ll.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+t);if(t>=1e9)throw new ul(ll.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+t);if(e<-62135596800)throw new ul(ll.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e);if(e>=253402300800)throw new ul(ll.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kl{static fromTimestamp(e){return new kl(e)}static min(){return new kl(new El(0,0))}static max(){return new kl(new El(253402300799,999999999))}compareTo(e){return this.timestamp._compareTo(e.timestamp)}isEqual(e){return this.timestamp.isEqual(e.timestamp)}toMicroseconds(){return 1e6*this.timestamp.seconds+this.timestamp.nanoseconds/1e3}toString(){return"SnapshotVersion("+this.timestamp.toString()+")"}toTimestamp(){return this.timestamp}constructor(e){this.timestamp=e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xl{static fromPath(e){return new xl(Cl.fromString(e))}static fromName(e){return new xl(Cl.fromString(e).popFirst(5))}static empty(){return new xl(Cl.emptyPath())}get collectionGroup(){return this.path.popLast().lastSegment()}hasCollectionId(e){return this.path.length>=2&&this.path.get(this.path.length-2)===e}getCollectionGroup(){return this.path.get(this.path.length-2)}getCollectionPath(){return this.path.popLast()}isEqual(e){return null!==e&&0===Cl.comparator(this.path,e.path)}toString(){return this.path.toString()}static comparator(e,t){return Cl.comparator(e.path,t.path)}static isDocumentKey(e){return e.length%2==0}static fromSegments(e){return new xl(new Cl(e.slice()))}constructor(e){this.path=e}}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ll{constructor(e,t,n,i){this.indexId=e,this.collectionGroup=t,this.fields=n,this.indexState=i}}Ll.UNKNOWN_ID=-1;function Dl(e,t){const n=e.toTimestamp().seconds,i=e.toTimestamp().nanoseconds+1,s=kl.fromTimestamp(1e9===i?new El(n+1,0):new El(n,i));return new Pl(s,xl.empty(),t)}function Rl(e){return new Pl(e.readTime,e.key,-1)}class Pl{static min(){return new Pl(kl.min(),xl.empty(),-1)}static max(){return new Pl(kl.max(),xl.empty(),-1)}constructor(e,t,n){this.readTime=e,this.documentKey=t,this.largestBatchId=n}}function Ol(e,t){let n=e.readTime.compareTo(t.readTime);return 0!==n?n:(n=xl.comparator(e.documentKey,t.documentKey),0!==n?n:_l(e.largestBatchId,t.largestBatchId))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jl(e){return"IndexedDbTransactionError"===e.name}
/**
 * @license
 ...
 * limitations under the License.
 */
class Bl{ut(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){const e=++this.previousValue;return this.ct&&this.ct(e),e}constructor(e,t){this.previousValue=e,t&&(t.sequenceNumberHandler=e=>this.ut(e),this.ct=e=>t.writeSequenceNumber(e))}}Bl.at=-1;
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hl(e){let t=0;for(const n in e)Object.prototype.hasOwnProperty.call(e,n)&&t++;return t}function Wl(e,t){for(const n in e)Object.prototype.hasOwnProperty.call(e,n)&&t(n,e[n])}function $l(e){for(const t in e)if(Object.prototype.hasOwnProperty.call(e,t))return!1;return!0}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kl(e){return null==e}function Gl(e){return 0===e&&1/e==-1/0}function Ql(e){return"number"==typeof e&&Number.isInteger(e)&&!Gl(e)&&e<=Number.MAX_SAFE_INTEGER&&e>=Number.MIN_SAFE_INTEGER}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tu(e){var t,n;return"server_timestamp"===(null===(n=((null===(t=null==e?void 0:e.mapValue)||void 0===t?void 0:t.fields)||{}).__type__)||void 0===n?void 0:n.stringValue)}function nu(e){const t=e.mapValue.fields.__previous_value__;return tu(t)?nu(t):t}function iu(e){const t=Yl(e.mapValue.fields.__local_write_time__.timestampValue);return new El(t.seconds,t.nanos)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _u{}class Iu extends _u{static create(e,t,n){return e.isKeyField()?"in"===t||"not-in"===t?this.createKeyFieldInFilter(e,t,n):new Lu(e,t,n):"array-contains"===t?new Ou(e,n):"in"===t?new Mu(e,n):"not-in"===t?new Uu(e,n):"array-contains-any"===t?new Fu(e,n):new Iu(e,t,n)}static createKeyFieldInFilter(e,t,n){return"in"===t?new Du(e,n):new Ru(e,n)}matches(e){const t=e.data.field(this.field);return"!="===this.op?null!==t&&this.matchesComparison(cu(t,this.value)):null!==t&&ru(this.value)===ru(t)&&this.matchesComparison(cu(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return 0===e;case"!=":return 0!==e;case">":return e>0;case">=":return e>=0;default:return ol()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}getFirstInequalityField(){return this.isInequality()?this.field:null}constructor(e,t,n){super(),this.field=e,this.op=t,this.value=n}}class Eu extends _u{static create(e,t){return new Eu(e,t)}matches(e){return ku(this)?void 0===this.filters.find((t=>!t.matches(e))):void 0!==this.filters.find((t=>t.matches(e)))}getFlattenedFilters(){return null!==this.ht||(this.ht=this.filters.reduce(((e,t)=>e.concat(t.getFlattenedFilters())),[])),this.ht}getFilters(){return Object.assign([],this.filters)}getFirstInequalityField(){const e=this.lt((e=>e.isInequality()));return null!==e?e.field:null}lt(e){for(const t of this.getFlattenedFilters())if(e(t))return t;return null}constructor(e,t){super(),this.filters=e,this.op=t,this.ht=null}}function ku(e){return"and"===e.op}function Su(e){return Cu(e)&&ku(e)}function Cu(e){for(const t of e.filters)if(t instanceof Eu)return!1;return!0}function Nu(e){if(e instanceof Iu)return e.field.canonicalString()+e.op.toString()+uu(e.value);if(Su(e))return e.filters.map((e=>Nu(e))).join(",");{const t=e.filters.map((e=>Nu(e))).join(",");return`${e.op}(${t})`}}function Au(e,t){return e instanceof Iu?function(e,t){return t instanceof Iu&&e.op===t.op&&e.field.isEqual(t.field)&&ou(e.value,t.value)}(e,t):e instanceof Eu?function(e,t){return t instanceof Eu&&e.op===t.op&&e.filters.length===t.filters.length&&e.filters.reduce(((e,n,i)=>e&&Au(n,t.filters[i])),!0)}(e,t):void ol()}function xu(e){return e instanceof Iu?function(e){return`${e.field.canonicalString()} ${e.op} ${uu(e.value)}`}(e):e instanceof Eu?function(e){return e.op.toString()+" {"+e.getFilters().map(xu).join(" ,")+"}"}(e):"Filter"}class Lu extends Iu{matches(e){const t=xl.comparator(e.key,this.key);return this.matchesComparison(t)}constructor(e,t,n){super(e,t,n),this.key=xl.fromName(n.referenceValue)}}class Du extends Iu{matches(e){return this.keys.some((t=>t.isEqual(e.key)))}constructor(e,t){super(e,"in",t),this.keys=Pu("in",t)}}class Ru extends Iu{matches(e){return!this.keys.some((t=>t.isEqual(e.key)))}constructor(e,t){super(e,"not-in",t),this.keys=Pu("not-in",t)}}function Pu(e,t){var n;return((null===(n=t.arrayValue)||void 0===n?void 0:n.values)||[]).map((e=>xl.fromName(e.referenceValue)))}class Ou extends Iu{matches(e){const t=e.data.field(this.field);return fu(t)&&au(t.arrayValue,this.value)}constructor(e,t){super(e,"array-contains",t)}}class Mu extends Iu{matches(e){const t=e.data.field(this.field);return null!==t&&au(this.value.arrayValue,t)}constructor(e,t){super(e,"in",t)}}class Uu extends Iu{matches(e){if(au(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return null!==t&&!au(this.value.arrayValue,t)}constructor(e,t){super(e,"not-in",t)}}class Fu extends Iu{matches(e){const t=e.data.field(this.field);return!(!fu(t)||!t.arrayValue.values)&&t.arrayValue.values.some((e=>au(this.value.arrayValue,e)))}constructor(e,t){super(e,"array-contains-any",t)}}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vu{constructor(e,t="asc"){this.field=e,this.dir=t}}function ju(e,t){return e.dir===t.dir&&e.field.isEqual(t.field)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class $u{static empty(){return new $u([])}unionWith(e){let t=new Hu(Al.comparator);for(const e of this.fields)t=t.add(e);for(const n of e)t=t.add(n);return new $u(t.toArray())}covers(e){for(const t of this.fields)if(t.isPrefixOf(e))return!0;return!1}isEqual(e){return Il(this.fields,e.fields,((e,t)=>e.isEqual(t)))}constructor(e){this.fields=e,e.sort(Al.comparator)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ku{static empty(){return new Ku({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let n=0;n<e.length-1;++n)if(t=(t.mapValue.fields||{})[e.get(n)],!gu(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=yu(t)}setAll(e){let t=Al.emptyPath(),n={},i=[];e.forEach(((e,s)=>{if(!t.isImmediateParentOf(s)){const e=this.getFieldsMap(t);this.applyChanges(e,n,i),n={},i=[],t=s.popLast()}e?n[s.lastSegment()]=yu(e):i.push(s.lastSegment())}));const s=this.getFieldsMap(t);this.applyChanges(s,n,i)}delete(e){const t=this.field(e.popLast());gu(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return ou(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let n=0;n<e.length;++n){let i=t.mapValue.fields[e.get(n)];gu(i)&&i.mapValue.fields||(i={mapValue:{fields:{}}},t.mapValue.fields[e.get(n)]=i),t=i}return t.mapValue.fields}applyChanges(e,t,n){Wl(t,((t,n)=>e[t]=n));for(const t of n)delete e[t]}clone(){return new Ku(yu(this.value))}constructor(e){this.value=e}}function Gu(e){const t=[];return Wl(e.fields,((e,n)=>{const i=new Al([e]);if(gu(n)){const e=Gu(n.mapValue).fields;if(0===e.length)t.push(i);else for(const n of e)t.push(i.child(n))}else t.push(i)})),new $u(t)
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xu{constructor(e,t=null,n=[],i=[],s=null,r=null,o=null){this.path=e,this.collectionGroup=t,this.orderBy=n,this.filters=i,this.limit=s,this.startAt=r,this.endAt=o,this.ft=null}}function Ju(e,t=null,n=[],i=[],s=null,r=null,o=null){return new Xu(e,t,n,i,s,r,o)}function Yu(e){const t=cl(e);if(null===t.ft){let e=t.path.canonicalString();null!==t.collectionGroup&&(e+="|cg:"+t.collectionGroup),e+="|f:",e+=t.filters.map((e=>Nu(e))).join(","),e+="|ob:",e+=t.orderBy.map((e=>function(e){return e.field.canonicalString()+e.dir}(e))).join(","),Kl(t.limit)||(e+="|l:",e+=t.limit),t.startAt&&(e+="|lb:",e+=t.startAt.inclusive?"b:":"a:",e+=t.startAt.position.map((e=>uu(e))).join(",")),t.endAt&&(e+="|ub:",e+=t.endAt.inclusive?"a:":"b:",e+=t.endAt.position.map((e=>uu(e))).join(",")),t.ft=e}return t.ft}function Zu(e,t){if(e.limit!==t.limit)return!1;if(e.orderBy.length!==t.orderBy.length)return!1;for(let n=0;n<e.orderBy.length;n++)if(!ju(e.orderBy[n],t.orderBy[n]))return!1;if(e.filters.length!==t.filters.length)return!1;for(let n=0;n<e.filters.length;n++)if(!Au(e.filters[n],t.filters[n]))return!1;return e.collectionGroup===t.collectionGroup&&!!e.path.isEqual(t.path)&&!!Tu(e.startAt,t.startAt)&&Tu(e.endAt,t.endAt)}function eh(e){return xl.isDocumentKey(e.path)&&null===e.collectionGroup&&0===e.filters.length}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Th{constructor(){this._=void 0}}function _h(e,t,n){return e instanceof kh?function(e,t){const n={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:e.seconds,nanos:e.nanoseconds}}}};return t&&(n.fields.__previous_value__=t),{mapValue:n}}(n,t):e instanceof Sh?Ch(e,t):e instanceof Nh?Ah(e,t):function(e,t){const n=Eh(e,t),i=Lh(n)+Lh(e.gt);return du(n)&&du(e.gt)?wh(i):vh(e.yt,i)}(e,t)}function Ih(e,t,n){return e instanceof Sh?Ch(e,t):e instanceof Nh?Ah(e,t):n}function Eh(e,t){var n;return e instanceof xh?du(n=t)||function(e){return!!e&&"doubleValue"in e}(n)?t:{integerValue:0}:null}class kh extends Th{}class Sh extends Th{constructor(e){super(),this.elements=e}}function Ch(e,t){const n=Dh(t);for(const t of e.elements)n.some((e=>ou(e,t)))||n.push(t);return{arrayValue:{values:n}}}class Nh extends Th{constructor(e){super(),this.elements=e}}function Ah(e,t){let n=Dh(t);for(const t of e.elements)n=n.filter((e=>!ou(e,t)));return{arrayValue:{values:n}}}class xh extends Th{constructor(e,t){super(),this.yt=e,this.gt=t}}function Lh(e){return Zl(e.integerValue||e.doubleValue)}function Dh(e){return fu(e)&&e.arrayValue.values?e.arrayValue.values.slice():[]}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rh{constructor(e,t){this.field=e,this.transform=t}}class Ph{constructor(e,t){this.version=e,this.transformResults=t}}class Oh{static none(){return new Oh}static exists(e){return new Oh(void 0,e)}static updateTime(e){return new Oh(e)}get isNone(){return void 0===this.updateTime&&void 0===this.exists}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}constructor(e,t){this.updateTime=e,this.exists=t}}function Mh(e,t){return void 0!==e.updateTime?t.isFoundDocument()&&t.version.isEqual(e.updateTime):void 0===e.exists||e.exists===t.isFoundDocument()}class Uh{}function Fh(e,t){if(!e.hasLocalMutations||t&&0===t.fields.length)return null;if(null===t)return e.isNoDocument()?new Gh(e.key,Oh.none()):new zh(e.key,e.data,Oh.none());{const n=e.data,i=Ku.empty();let s=new Hu(Al.comparator);for(let e of t.fields)if(!s.has(e)){let t=n.field(e);null===t&&e.length>1&&(e=e.popLast(),t=n.field(e)),null===t?i.delete(e):i.set(e,t),s=s.add(e)}return new Hh(e.key,i,new $u(s.toArray()),Oh.none())}}function Vh(e,t,n){e instanceof zh?function(e,t,n){const i=e.value.clone(),s=$h(e.fieldTransforms,t,n.transformResults);i.setAll(s),t.convertToFoundDocument(n.version,i).setHasCommittedMutations()}(e,t,n):e instanceof Hh?function(e,t,n){if(!Mh(e.precondition,t))return void t.convertToUnknownDocument(n.version);const i=$h(e.fieldTransforms,t,n.transformResults),s=t.data;s.setAll(Wh(e)),s.setAll(i),t.convertToFoundDocument(n.version,s).setHasCommittedMutations()}(e,t,n):function(e,t,n){t.convertToNoDocument(n.version).setHasCommittedMutations()}(0,t,n)}function jh(e,t,n,i){return e instanceof zh?function(e,t,n,i){if(!Mh(e.precondition,t))return n;const s=e.value.clone(),r=Kh(e.fieldTransforms,i,t);return s.setAll(r),t.convertToFoundDocument(t.version,s).setHasLocalMutations(),null}(e,t,n,i):e instanceof Hh?function(e,t,n,i){if(!Mh(e.precondition,t))return n;const s=Kh(e.fieldTransforms,i,t),r=t.data;return r.setAll(Wh(e)),r.setAll(s),t.convertToFoundDocument(t.version,r).setHasLocalMutations(),null===n?null:n.unionWith(e.fieldMask.fields).unionWith(e.fieldTransforms.map((e=>e.field)))}(e,t,n,i):function(e,t,n){return Mh(e.precondition,t)?(t.convertToNoDocument(t.version).setHasLocalMutations(),null):n}(e,t,n)}function Bh(e,t){let n=null;for(const i of e.fieldTransforms){const e=t.data.field(i.field),s=Eh(i.transform,e||null);null!=s&&(null===n&&(n=Ku.empty()),n.set(i.field,s))}return n||null}function qh(e,t){return e.type===t.type&&!!e.key.isEqual(t.key)&&!!e.precondition.isEqual(t.precondition)&&!!function(e,t){return void 0===e&&void 0===t||!(!e||!t)&&Il(e,t,((e,t)=>function(e,t){return e.field.isEqual(t.field)&&function(e,t){return e instanceof Sh&&t instanceof Sh||e instanceof Nh&&t instanceof Nh?Il(e.elements,t.elements,ou):e instanceof xh&&t instanceof xh?ou(e.gt,t.gt):e instanceof kh&&t instanceof kh}(e.transform,t.transform)}(e,t)))}(e.fieldTransforms,t.fieldTransforms)&&(0===e.type?e.value.isEqual(t.value):1!==e.type||e.data.isEqual(t.data)&&e.fieldMask.isEqual(t.fieldMask))}class zh extends Uh{getFieldMask(){return null}constructor(e,t,n,i=[]){super(),this.key=e,this.value=t,this.precondition=n,this.fieldTransforms=i,this.type=0}}class Hh extends Uh{getFieldMask(){return this.fieldMask}constructor(e,t,n,i,s=[]){super(),this.key=e,this.data=t,this.fieldMask=n,this.precondition=i,this.fieldTransforms=s,this.type=1}}function Wh(e){const t=new Map;return e.fieldMask.fields.forEach((n=>{if(!n.isEmpty()){const i=e.data.field(n);t.set(n,i)}})),t}function $h(e,t,n){const i=new Map;al(e.length===n.length);for(let s=0;s<n.length;s++){const r=e[s],o=r.transform,a=t.data.field(r.field);i.set(r.field,Ih(o,a,n[s]))}return i}function Kh(e,t,n){const i=new Map;for(const s of e){const e=s.transform,r=n.data.field(s.field);i.set(s.field,_h(e,r,t))}return i}class Gh extends Uh{getFieldMask(){return null}constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}}class Qh extends Uh{getFieldMask(){return null}constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class td{get(e){const t=this.mapKeyFn(e),n=this.inner[t];if(void 0!==n)for(const[t,i]of n)if(this.equalsFn(t,e))return i}has(e){return void 0!==this.get(e)}set(e,t){const n=this.mapKeyFn(e),i=this.inner[n];if(void 0===i)return this.inner[n]=[[e,t]],void this.innerSize++;for(let n=0;n<i.length;n++)if(this.equalsFn(i[n][0],e))return void(i[n]=[e,t]);i.push([e,t]),this.innerSize++}delete(e){const t=this.mapKeyFn(e),n=this.inner[t];if(void 0===n)return!1;for(let i=0;i<n.length;i++)if(this.equalsFn(n[i][0],e))return 1===n.length?delete this.inner[t]:n.splice(i,1),this.innerSize--,!0;return!1}forEach(e){Wl(this.inner,((t,n)=>{for(const[t,i]of n)e(t,i)}))}isEmpty(){return $l(this.inner)}size(){return this.innerSize}constructor(e,t){this.mapKeyFn=e,this.equalsFn=t,this.inner={},this.innerSize=0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nd=new Bu(xl.comparator);function id(){return nd}const sd=new Bu(xl.comparator);function rd(...e){let t=sd;for(const n of e)t=t.insert(n.key,n);return t}function od(e){let t=sd;return e.forEach(((e,n)=>t=t.insert(e,n.overlayedDocument))),t}function ad(){return ld()}function cd(){return ld()}function ld(){return new td((e=>e.toString()),((e,t)=>e.isEqual(t)))}const ud=new Bu(xl.comparator),hd=new Hu(xl.comparator);function dd(...e){let t=hd;for(const n of e)t=t.add(n);return t}const fd=new Hu(_l);function pd(){return fd}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ed={asc:"ASCENDING",desc:"DESCENDING"},kd={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},Sd={and:"AND",or:"OR"};class Cd{constructor(e,t){this.databaseId=e,this.wt=t}}function Nd(e,t){return e.wt?`${new Date(1e3*t.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+t.nanoseconds).slice(-9)}Z`:{seconds:""+t.seconds,nanos:t.nanoseconds}}function Ad(e,t){return e.wt?t.toBase64():t.toUint8Array()}function xd(e,t){return Nd(e,t.toTimestamp())}function Ld(e){return al(!!e),kl.fromTimestamp(function(e){const t=Yl(e);return new El(t.seconds,t.nanos)}(e))}function Dd(e,t){return function(e){return new Cl(["projects",e.projectId,"databases",e.database])}(e).child("documents").child(t).canonicalString()}function Rd(e){const t=Cl.fromString(e);return al(Zd(t)),t}function Pd(e,t){return Dd(e.databaseId,t.path)}function Od(e,t){const n=Rd(t);if(n.get(1)!==e.databaseId.projectId)throw new ul(ll.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+n.get(1)+" vs "+e.databaseId.projectId);if(n.get(3)!==e.databaseId.database)throw new ul(ll.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+n.get(3)+" vs "+e.databaseId.database);return new xl(Vd(n))}function Md(e,t){return Dd(e.databaseId,t)}function Ud(e){const t=Rd(e);return 4===t.length?Cl.emptyPath():Vd(t)}function Fd(e){return new Cl(["projects",e.databaseId.projectId,"databases",e.databaseId.database]).canonicalString()}function Vd(e){return al(e.length>4&&"documents"===e.get(4)),e.popFirst(5)}function jd(e,t,n){return{name:Pd(e,t),fields:n.value.mapValue.fields}}function Bd(e,t){let n;if(t instanceof zh)n={update:jd(e,t.key,t.value)};else if(t instanceof Gh)n={delete:Pd(e,t.key)};else if(t instanceof Hh)n={update:jd(e,t.key,t.data),updateMask:Yd(t.fieldMask)};else{if(!(t instanceof Qh))return ol();n={verify:Pd(e,t.key)}}return t.fieldTransforms.length>0&&(n.updateTransforms=t.fieldTransforms.map((e=>function(e,t){const n=t.transform;if(n instanceof kh)return{fieldPath:t.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(n instanceof Sh)return{fieldPath:t.field.canonicalString(),appendMissingElements:{values:n.elements}};if(n instanceof Nh)return{fieldPath:t.field.canonicalString(),removeAllFromArray:{values:n.elements}};if(n instanceof xh)return{fieldPath:t.field.canonicalString(),increment:n.gt};throw ol()}(0,e)))),t.precondition.isNone||(n.currentDocument=function(e,t){return void 0!==t.updateTime?{updateTime:xd(e,t.updateTime)}:void 0!==t.exists?{exists:t.exists}:ol()}(e,t.precondition)),n}function qd(e,t){return{documents:[Md(e,t.path)]}}function zd(e,t){const n={structuredQuery:{}},i=t.path;null!==t.collectionGroup?(n.parent=Md(e,i),n.structuredQuery.from=[{collectionId:t.collectionGroup,allDescendants:!0}]):(n.parent=Md(e,i.popLast()),n.structuredQuery.from=[{collectionId:i.lastSegment()}]);const s=function(e){if(0!==e.length)return Jd(Eu.create(e,"and"))}(t.filters);s&&(n.structuredQuery.where=s);const r=function(e){if(0!==e.length)return e.map((e=>function(e){return{field:Qd(e.field),direction:$d(e.dir)}}(e)))}(t.orderBy);r&&(n.structuredQuery.orderBy=r);const o=function(e,t){return e.wt||Kl(t)?t:{value:t}}(e,t.limit);var a;return null!==o&&(n.structuredQuery.limit=o),t.startAt&&(n.structuredQuery.startAt={before:(a=t.startAt).inclusive,values:a.position}),t.endAt&&(n.structuredQuery.endAt=function(e){return{before:!e.inclusive,values:e.position}}(t.endAt)),n}function Hd(e){let t=Ud(e.parent);const n=e.structuredQuery,i=n.from?n.from.length:0;let s=null;if(i>0){al(1===i);const e=n.from[0];e.allDescendants?s=e.collectionId:t=t.child(e.collectionId)}let r=[];n.where&&(r=function(e){const t=Wd(e);return t instanceof Eu&&Su(t)?t.getFilters():[t]}(n.where));let o=[];n.orderBy&&(o=n.orderBy.map((e=>function(e){return new Vu(Xd(e.field),function(e){switch(e){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(e.direction))}(e))));let a=null;n.limit&&(a=function(e){let t;return t="object"==typeof e?e.value:e,Kl(t)?null:t}(n.limit));let c=null;n.startAt&&(c=function(e){const t=!!e.before,n=e.values||[];return new wu(n,t)}(n.startAt));let l=null;return n.endAt&&(l=function(e){const t=!e.before,n=e.values||[];return new wu(n,t)}(n.endAt)),nh(t,s,o,r,a,"F",c,l)}function Wd(e){return void 0!==e.unaryFilter?function(e){switch(e.unaryFilter.op){case"IS_NAN":const t=Xd(e.unaryFilter.field);return Iu.create(t,"==",{doubleValue:NaN});case"IS_NULL":const n=Xd(e.unaryFilter.field);return Iu.create(n,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const i=Xd(e.unaryFilter.field);return Iu.create(i,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const s=Xd(e.unaryFilter.field);return Iu.create(s,"!=",{nullValue:"NULL_VALUE"});default:return ol()}}(e):void 0!==e.fieldFilter?function(e){return Iu.create(Xd(e.fieldFilter.field),function(e){switch(e){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";default:return ol()}}(e.fieldFilter.op),e.fieldFilter.value)}(e):void 0!==e.compositeFilter?function(e){return Eu.create(e.compositeFilter.filters.map((e=>Wd(e))),function(e){switch(e){case"AND":return"and";case"OR":return"or";default:return ol()}}(e.compositeFilter.op))}(e):ol()}function $d(e){return Ed[e]}function Kd(e){return kd[e]}function Gd(e){return Sd[e]}function Qd(e){return{fieldPath:e.canonicalString()}}function Xd(e){return Al.fromServerFormat(e.fieldPath)}function Jd(e){return e instanceof Iu?function(e){if("=="===e.op){if(mu(e.value))return{unaryFilter:{field:Qd(e.field),op:"IS_NAN"}};if(pu(e.value))return{unaryFilter:{field:Qd(e.field),op:"IS_NULL"}}}else if("!="===e.op){if(mu(e.value))return{unaryFilter:{field:Qd(e.field),op:"IS_NOT_NAN"}};if(pu(e.value))return{unaryFilter:{field:Qd(e.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:Qd(e.field),op:Kd(e.op),value:e.value}}}(e):e instanceof Eu?function(e){const t=e.getFilters().map((e=>Jd(e)));return 1===t.length?t[0]:{compositeFilter:{op:Gd(e.op),filters:t}}}(e):ol()}function Yd(e){const t=[];return e.fields.forEach((e=>t.push(e.canonicalString()))),{fieldPaths:t}}function Zd(e){return e.length>=4&&"projects"===e.get(0)&&"databases"===e.get(2)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bf{isEmpty(){return this.ns.isEmpty()}addReference(e,t){const n=new Tf(e,t);this.ns=this.ns.add(n),this.rs=this.rs.add(n)}us(e,t){e.forEach((e=>this.addReference(e,t)))}removeReference(e,t){this.cs(new Tf(e,t))}hs(e,t){e.forEach((e=>this.removeReference(e,t)))}ls(e){const t=new xl(new Cl([])),n=new Tf(t,e),i=new Tf(t,e+1),s=[];return this.rs.forEachInRange([n,i],(e=>{this.cs(e),s.push(e.key)})),s}fs(){this.ns.forEach((e=>this.cs(e)))}cs(e){this.ns=this.ns.delete(e),this.rs=this.rs.delete(e)}ds(e){const t=new xl(new Cl([])),n=new Tf(t,e),i=new Tf(t,e+1);let s=dd();return this.rs.forEachInRange([n,i],(e=>{s=s.add(e.key)})),s}containsKey(e){const t=new Tf(e,0),n=this.ns.firstAfterOrEqual(t);return null!==n&&e.isEqual(n.key)}constructor(){this.ns=new Hu(Tf.ss),this.rs=new Hu(Tf.os)}}class Tf{static ss(e,t){return xl.comparator(e.key,t.key)||_l(e._s,t._s)}static os(e,t){return _l(e._s,t._s)||xl.comparator(e.key,t.key)}constructor(e,t){this.key=e,this._s=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sf{start(){return Promise.resolve()}shutdown(){return this.Ds=!1,Promise.resolve()}get started(){return this.Ds}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new wf,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let n=this.Vs[e.toKey()];return n||(n=new _f(t,this.referenceDelegate),this.Vs[e.toKey()]=n),n}getTargetCache(){return this.Cs}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Ns}runTransaction(e,t,n){nl("MemoryPersistence","Starting transaction:",e);const i=new Cf(this.Ss.next());return this.referenceDelegate.ks(),n(i).next((e=>this.referenceDelegate.Os(i).next((()=>e)))).toPromise().then((e=>(i.raiseOnCommittedEvent(),e)))}Ms(e,t){return Vl.or(Object.values(this.Vs).map((n=>()=>n.containsKey(e,t))))}constructor(e,t){this.Vs={},this.overlays={},this.Ss=new Bl(0),this.Ds=!1,this.Ds=!0,this.referenceDelegate=e(this),this.Cs=new kf(this),this.indexManager=new hf,this.remoteDocumentCache=function(e){return new If(e)}((e=>this.referenceDelegate.xs(e))),this.yt=new cf(t),this.Ns=new vf(this.yt)}}class Cf extends Ul{constructor(e){super(),this.currentSequenceNumber=e}}class Nf{static Bs(e){return new Nf(e)}get Ls(){if(this.$s)return this.$s;throw ol()}addReference(e,t,n){return this.Fs.addReference(n,t),this.Ls.delete(n.toString()),Vl.resolve()}removeReference(e,t,n){return this.Fs.removeReference(n,t),this.Ls.add(n.toString()),Vl.resolve()}markPotentiallyOrphaned(e,t){return this.Ls.add(t.toString()),Vl.resolve()}removeTarget(e,t){this.Fs.ls(t.targetId).forEach((e=>this.Ls.add(e.toString())));const n=this.persistence.getTargetCache();return n.getMatchingKeysForTargetId(e,t.targetId).next((e=>{e.forEach((e=>this.Ls.add(e.toString())))})).next((()=>n.removeTargetData(e,t)))}ks(){this.$s=new Set}Os(e){const t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return Vl.forEach(this.Ls,(n=>{const i=xl.fromPath(n);return this.qs(e,i).next((e=>{e||t.removeEntry(i,kl.min())}))})).next((()=>(this.$s=null,t.apply(e))))}updateLimboDocument(e,t){return this.qs(e,t).next((e=>{e?this.Ls.delete(t.toString()):this.Ls.add(t.toString())}))}xs(e){return 0}qs(e,t){return Vl.or([()=>Vl.resolve(this.Fs.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.Ms(e,t)])}constructor(e){this.persistence=e,this.Fs=new bf,this.$s=null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Af{static Ci(e,t){let n=dd(),i=dd();for(const e of t.docChanges)switch(e.type){case 0:n=n.add(e.doc.key);break;case 1:i=i.add(e.doc.key)}return new Af(e,t.fromCache,n,i)}constructor(e,t,n,i){this.targetId=e,this.fromCache=t,this.Si=n,this.Di=i}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $f{Yr(e){this.Xr=e}Zr(e){this.eo=e}onMessage(e){this.no=e}close(){this.Jr()}send(e){this.Hr(e)}so(){this.Xr()}io(e){this.eo(e)}ro(e){this.no(e)}constructor(e){this.Hr=e.Hr,this.Jr=e.Jr}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class np{constructor(e,t,n,i,s){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.fu=[],this.du=new Map,this._u=new Set,this.wu=[],this.mu=s,this.mu.Ur((e=>{n.enqueueAndForget((async()=>{hp(this)&&(nl("RemoteStore","Restarting streams for network reachability change."),await async function(e){const t=cl(e);t._u.add(4),await sp(t),t.gu.set("Unknown"),t._u.delete(4),await ip(t)}(this))}))})),this.gu=new tp(n,i)}}async function ip(e){if(hp(e))for(const t of e.wu)await t(!0)}async function sp(e){for(const t of e.wu)await t(!1)}function rp(e,t){const n=cl(e);n.du.has(t.targetId)||(n.du.set(t.targetId,t),up(n)?lp(n):Ap(n).ko()&&ap(n,t))}function op(e,t){const n=cl(e),i=Ap(n);n.du.delete(t),i.ko()&&cp(n,t),0===n.du.size&&(i.ko()?i.Fo():hp(n)&&n.gu.set("Unknown"))}function ap(e,t){e.yu.Ot(t.targetId),Ap(e).zo(t)}function cp(e,t){e.yu.Ot(t),Ap(e).Ho(t)}function lp(e){e.yu=new Td({getRemoteKeysForTarget:t=>e.remoteSyncer.getRemoteKeysForTarget(t),ne:t=>e.du.get(t)||null}),Ap(e).start(),e.gu.uu()}function up(e){return hp(e)&&!Ap(e).No()&&e.du.size>0}function hp(e){return 0===cl(e)._u.size}function dp(e){e.yu=void 0}async function fp(e){e.du.forEach(((t,n)=>{ap(e,t)}))}async function pp(e,t){dp(e),up(e)?(e.gu.hu(t),lp(e)):e.gu.set("Unknown")}async function mp(e,t,n){if(e.gu.set("Online"),t instanceof wd&&2===t.state&&t.cause)try{await async function(e,t){const n=t.cause;for(const i of t.targetIds)e.du.has(i)&&(await e.remoteSyncer.rejectListen(i,n),e.du.delete(i),e.yu.removeTarget(i))}(e,t)}catch(n){nl("RemoteStore","Failed to remove targets %s: %s ",t.targetIds.join(","),n),await gp(e,n)}else if(t instanceof yd?e.yu.Kt(t):t instanceof vd?e.yu.Jt(t):e.yu.jt(t),!n.isEqual(kl.min()))try{const t=await Pf(e.localStore);n.compareTo(t)>=0&&await function(e,t){const n=e.yu.Zt(t);return n.targetChanges.forEach(((n,i)=>{if(n.resumeToken.approximateByteSize()>0){const s=e.du.get(i);s&&e.du.set(i,s.withResumeToken(n.resumeToken,t))}})),n.targetMismatches.forEach((t=>{const n=e.du.get(t);if(!n)return;e.du.set(t,n.withResumeToken(Xl.EMPTY_BYTE_STRING,n.snapshotVersion)),cp(e,t);const i=new af(n.target,t,1,n.sequenceNumber);ap(e,i)})),e.remoteSyncer.applyRemoteEvent(n)}(e,n)}catch(t){nl("RemoteStore","Failed to raise snapshot:",t),await gp(e,t)}}async function gp(e,t,n){if(!jl(t))throw t;e._u.add(1),await sp(e),e.gu.set("Offline"),n||(n=()=>Pf(e.localStore)),e.asyncQueue.enqueueRetryable((async()=>{nl("RemoteStore","Retrying IndexedDB access"),await n(),e._u.delete(1),await ip(e)}))}function yp(e,t){return t().catch((n=>gp(e,n,t)))}async function vp(e){const t=cl(e),n=xp(t);let i=t.fu.length>0?t.fu[t.fu.length-1].batchId:-1;for(;wp(t);)try{const e=await Mf(t.localStore,i);if(null===e){0===t.fu.length&&n.Fo();break}i=e.batchId,bp(t,e)}catch(e){await gp(t,e)}Tp(t)&&_p(t)}function wp(e){return hp(e)&&e.fu.length<10}function bp(e,t){e.fu.push(t);const n=xp(e);n.ko()&&n.Yo&&n.Xo(t.mutations)}function Tp(e){return hp(e)&&!xp(e).No()&&e.fu.length>0}function _p(e){xp(e).start()}async function Ip(e){xp(e).eu()}async function Ep(e){const t=xp(e);for(const n of e.fu)t.Xo(n.mutations)}async function kp(e,t,n){const i=e.fu.shift(),s=rf.from(i,t,n);await yp(e,(()=>e.remoteSyncer.applySuccessfulWrite(s))),await vp(e)}async function Sp(e,t){t&&xp(e).Yo&&await async function(e,t){if(Zh(n=t.code)&&n!==ll.ABORTED){const n=e.fu.shift();xp(e).Mo(),await yp(e,(()=>e.remoteSyncer.rejectFailedWrite(n.batchId,t))),await vp(e)}var n}(e,t),Tp(e)&&_p(e)}async function Cp(e,t){const n=cl(e);n.asyncQueue.verifyOperationInProgress(),nl("RemoteStore","RemoteStore received new credentials");const i=hp(n);n._u.add(3),await sp(n),i&&n.gu.set("Unknown"),await n.remoteSyncer.handleCredentialChange(t),n._u.delete(3),await ip(n)}async function Np(e,t){const n=cl(e);t?(n._u.delete(2),await ip(n)):t||(n._u.add(2),await sp(n),n.gu.set("Unknown"))}function Ap(e){return e.pu||(e.pu=function(e,t,n){const i=cl(e);return i.su(),new Yf(t,i.connection,i.authCredentials,i.appCheckCredentials,i.yt,n)}(e.datastore,e.asyncQueue,{Yr:fp.bind(null,e),Zr:pp.bind(null,e),Wo:mp.bind(null,e)}),e.wu.push((async t=>{t?(e.pu.Mo(),up(e)?lp(e):e.gu.set("Unknown")):(await e.pu.stop(),dp(e))}))),e.pu}function xp(e){return e.Iu||(e.Iu=function(e,t,n){const i=cl(e);return i.su(),new Zf(t,i.connection,i.authCredentials,i.appCheckCredentials,i.yt,n)}(e.datastore,e.asyncQueue,{Yr:Ip.bind(null,e),Zr:Sp.bind(null,e),tu:Ep.bind(null,e),Zo:kp.bind(null,e)}),e.wu.push((async t=>{t?(e.Iu.Mo(),await vp(e)):(await e.Iu.stop(),e.fu.length>0&&(nl("RemoteStore",`Stopping write stream with ${e.fu.length} pending writes`),e.fu=[]))}))),e.Iu
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class km{get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Cm(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new km(this.firestore,e,this._key)}constructor(e,t,n){this.converter=t,this._key=n,this.type="document",this.firestore=e}}class Sm{withConverter(e){return new Sm(this.firestore,e,this._query)}constructor(e,t,n){this.converter=t,this._query=n,this.type="query",this.firestore=e}}class Cm extends Sm{get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new km(this.firestore,null,new xl(e))}withConverter(e){return new Cm(this.firestore,e,this._path)}constructor(e,t,n){super(e,t,ih(n)),this._path=n,this.type="collection"}}function Nm(e,t,...n){if(e=G(e),1===arguments.length&&(t=Tl.R()),vm("doc","path",t),e instanceof Em){const i=Cl.fromString(t,...n);return wm(i),new km(e,null,new xl(i))}{if(!(e instanceof km||e instanceof Cm))throw new ul(ll.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const i=e._path.child(Cl.fromString(t,...n));return wm(i),new km(e.firestore,e instanceof Cm?e.converter:null,new xl(i))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Am{next(e){this.observer.next&&this.Rc(this.observer.next,e)}error(e){this.observer.error?this.Rc(this.observer.error,e):il("Uncaught Error in snapshot listener:",e.toString())}bc(){this.muted=!0}Rc(e,t){this.muted||setTimeout((()=>{this.muted||e(t)}),0)}constructor(e){this.observer=e,this.muted=!1}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hm{isEqual(e){return this._internalPath.isEqual(e._internalPath)}constructor(...e){for(let t=0;t<e.length;++t)if(0===e[t].length)throw new ul(ll.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Al(e)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $m{get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return _l(this._lat,e._lat)||_l(this._long,e._long)}constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new ul(ll.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new ul(ll.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Km=/^__.*__$/;class Gm{toMutation(e,t){return null!==this.fieldMask?new Hh(e,this.data,this.fieldMask,t,this.fieldTransforms):new zh(e,this.data,t,this.fieldTransforms)}constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}}function Qm(e){switch(e){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw ol()}}class Xm{get path(){return this.settings.path}get sa(){return this.settings.sa}ia(e){return new Xm(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.yt,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}ra(e){var t;const n=null===(t=this.path)||void 0===t?void 0:t.child(e),i=this.ia({path:n,oa:!1});return i.ua(e),i}ca(e){var t;const n=null===(t=this.path)||void 0===t?void 0:t.child(e),i=this.ia({path:n,oa:!1});return i.na(),i}aa(e){return this.ia({path:void 0,oa:!0})}ha(e){return cg(e,this.settings.methodName,this.settings.la||!1,this.path,this.settings.fa)}contains(e){return void 0!==this.fieldMask.find((t=>e.isPrefixOf(t)))||void 0!==this.fieldTransforms.find((t=>e.isPrefixOf(t.field)))}na(){if(this.path)for(let e=0;e<this.path.length;e++)this.ua(this.path.get(e))}ua(e){if(0===e.length)throw this.ha("Document fields must not be empty");if(Qm(this.sa)&&Km.test(e))throw this.ha('Document fields cannot begin and end with "__"')}constructor(e,t,n,i,s,r){this.settings=e,this.databaseId=t,this.yt=n,this.ignoreUndefinedProperties=i,void 0===s&&this.na(),this.fieldTransforms=s||[],this.fieldMask=r||[]}}class Jm{da(e,t,n,i=!1){return new Xm({sa:e,methodName:t,fa:n,path:Al.emptyPath(),oa:!1,la:i},this.databaseId,this.yt,this.ignoreUndefinedProperties)}constructor(e,t,n){this.databaseId=e,this.ignoreUndefinedProperties=t,this.yt=n||Qf(e)}}function Ym(e){const t=e._freezeSettings(),n=Qf(e._databaseId);return new Jm(e._databaseId,!!t.ignoreUndefinedProperties,n)}function Zm(e,t,n,i,s,r={}){const o=e.da(r.merge||r.mergeFields?2:0,t,n,s);sg("Data must be an object, but it was:",o,i);const a=ng(i,o);let c,l;if(r.merge)c=new $u(o.fieldMask),l=o.fieldTransforms;else if(r.mergeFields){const e=[];for(const i of r.mergeFields){const s=rg(t,i,n);if(!o.contains(s))throw new ul(ll.INVALID_ARGUMENT,`Field '${s}' is specified in your field mask but missing from your input data.`);lg(e,s)||e.push(s)}c=new $u(e),l=o.fieldTransforms.filter((e=>c.covers(e.field)))}else c=null,l=o.fieldTransforms;return new Gm(new Ku(a),c,l)}class eg extends Wm{_toFieldTransform(e){return new Rh(e.path,new kh)}isEqual(e){return e instanceof eg}}function tg(e,t){if(ig(e=G(e)))return sg("Unsupported field value:",t,e),ng(e,t);if(e instanceof Wm)return function(e,t){if(!Qm(t.sa))throw t.ha(`${e._methodName}() can only be used with update() and set()`);if(!t.path)throw t.ha(`${e._methodName}() is not currently supported inside arrays`);const n=e._toFieldTransform(t);n&&t.fieldTransforms.push(n)}(e,t),null;if(void 0===e&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),e instanceof Array){if(t.settings.oa&&4!==t.sa)throw t.ha("Nested arrays are not supported");return function(e,t){const n=[];let i=0;for(const s of e){let e=tg(s,t.aa(i));null==e&&(e={nullValue:"NULL_VALUE"}),n.push(e),i++}return{arrayValue:{values:n}}}(e,t)}return function(e,t){if(null===(e=G(e)))return{nullValue:"NULL_VALUE"};if("number"==typeof e)return bh(t.yt,e);if("boolean"==typeof e)return{booleanValue:e};if("string"==typeof e)return{stringValue:e};if(e instanceof Date){const n=El.fromDate(e);return{timestampValue:Nd(t.yt,n)}}if(e instanceof El){const n=new El(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:Nd(t.yt,n)}}if(e instanceof $m)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof zm)return{bytesValue:Ad(t.yt,e._byteString)};if(e instanceof km){const n=t.databaseId,i=e.firestore._databaseId;if(!i.isEqual(n))throw t.ha(`Document reference is for database ${i.projectId}/${i.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:Dd(e.firestore._databaseId||t.databaseId,e._key.path)}}throw t.ha(`Unsupported field value: ${bm(e)}`)}(e,t)}function ng(e,t){const n={};return $l(e)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):Wl(e,((e,i)=>{const s=tg(i,t.ra(e));null!=s&&(n[e]=s)})),{mapValue:{fields:n}}}function ig(e){return!("object"!=typeof e||null===e||e instanceof Array||e instanceof Date||e instanceof El||e instanceof $m||e instanceof zm||e instanceof km||e instanceof Wm)}function sg(e,t,n){if(!ig(n)||!function(e){return"object"==typeof e&&null!==e&&(Object.getPrototypeOf(e)===Object.prototype||null===Object.getPrototypeOf(e))}(n)){const i=bm(n);throw"an object"===i?t.ha(e+" a custom object"):t.ha(e+" "+i)}}function rg(e,t,n){if((t=G(t))instanceof Hm)return t._internalPath;if("string"==typeof t)return ag(e,t);throw cg("Field path arguments must be of type string or ",e,!1,void 0,n)}const og=new RegExp("[~\\*/\\[\\]]");function ag(e,t,n){if(t.search(og)>=0)throw cg(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,!1,void 0,n);try{return new Hm(...t.split("."))._internalPath}catch(i){throw cg(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,!1,void 0,n)}}function cg(e,t,n,i,s){const r=i&&!i.isEmpty(),o=void 0!==s;let a=`Function ${t}() called with invalid data`;n&&(a+=" (via `toFirestore()`)"),a+=". ";let c="";return(r||o)&&(c+=" (found",r&&(c+=` in field ${i}`),o&&(c+=` in document ${s}`),c+=")"),new ul(ll.INVALID_ARGUMENT,a+e+c)}function lg(e,t){return e.some((e=>e.isEqual(t)))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function vg(e){e=Tm(e,km);const t=Tm(e.firestore,Vm);return Um(Bm(t),e._key).then((n=>_g(t,e,n)))}class wg extends fg{convertBytes(e){return new zm(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new km(this.firestore,null,t)}constructor(e){super(),this.firestore=e}}function bg(e,t,n){e=Tm(e,km);const i=Tm(e.firestore,Vm),s=pg(e.converter,t,n);return Tg(i,[Zm(Ym(i),"setDoc",e._key,s,null!==e.converter,n).toMutation(e._key,Oh.none())])}function Tg(e,t){return function(e,t){const n=new hl;return e.asyncQueue.enqueueAndForget((async()=>async function(e,t,n){const i=mm(e);try{const e=await function(e,t){const n=cl(e),i=El.now(),s=t.reduce(((e,t)=>e.add(t.key)),dd());let r,o;return n.persistence.runTransaction("Locally write mutations","readwrite",(e=>{let a=id(),c=dd();return n.Gi.getEntries(e,s).next((e=>{a=e,a.forEach(((e,t)=>{t.isValidDocument()||(c=c.add(e))}))})).next((()=>n.localDocuments.getOverlayedDocuments(e,a))).next((s=>{r=s;const o=[];for(const e of t){const t=Bh(e,r.get(e.key).overlayedDocument);null!=t&&o.push(new Hh(e.key,t,Gu(t.value.mapValue),Oh.exists(!0)))}return n.mutationQueue.addMutationBatch(e,i,o,t)})).next((t=>{o=t;const i=t.applyToLocalDocumentSet(r,c);return n.documentOverlayCache.saveOverlays(e,t.batchId,i)}))})).then((()=>({batchId:o.batchId,changes:od(r)})))}(i.localStore,t);i.sharedClientState.addPendingMutation(e.batchId),function(e,t,n){let i=e.hc[e.currentUser.toKey()];i||(i=new Bu(_l)),i=i.insert(t,n),e.hc[e.currentUser.toKey()]=i}(i,e.batchId,n),await hm(i,e.changes),await vp(i.remoteStore)}catch(e){const t=Dp(e,"Failed to persist write");n.reject(t)}}(await Om(e),t,n))),n.promise}(Bm(e),t)}function _g(e,t,n){const i=n.docs.get(t._key),s=new wg(e);return new gg(e,s,t._key,i,new mg(n.hasPendingWrites,n.fromCache),t.converter)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */!function(e,t=!0){Zc=Fe,Pe(new Q("firestore",((e,{instanceIdentifier:n,options:i})=>{const s=e.getProvider("app").getImmediate(),r=new Vm(new ml(e.getProvider("auth-internal")),new wl(e.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new ul(ll.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new zl(e.options.projectId,t)}(s,n),s);return i=Object.assign({useFetchStreams:t},i),r._setSettings(i),r}),"PUBLIC").setMultipleInstances(!0)),Be(Jc,"3.8.3",e),Be(Jc,"3.8.3","esm2017")}();
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class kg extends M{get status(){return this.status_}set status(e){this.status_=e}_codeEquals(e){return xg(e)===this.code}get serverResponse(){return this.customData.serverResponse}set serverResponse(e){this.customData.serverResponse=e,this.customData.serverResponse?this.message=`${this._baseMessage}\n${this.customData.serverResponse}`:this.message=this._baseMessage}constructor(e,t,n=0){super(xg(e),`Firebase Storage: ${t} (${xg(e)})`),this.status_=n,this.customData={serverResponse:null},this._baseMessage=this.message,Object.setPrototypeOf(this,kg.prototype)}}var Sg,Cg,Ng,Ag;function xg(e){return"storage/"+e}function Lg(){return new kg(Sg.UNKNOWN,"An unknown error occurred, please check the error payload for server response.")}function Dg(){return new kg(Sg.RETRY_LIMIT_EXCEEDED,"Max retry time for operation exceeded, please try again.")}function Rg(){return new kg(Sg.CANCELED,"User canceled the upload/download.")}function Pg(e){return new kg(Sg.INVALID_ARGUMENT,e)}function Og(){return new kg(Sg.APP_DELETED,"The Firebase app was deleted.")}(Cg=Sg||(Sg={})).UNKNOWN="unknown",Cg.OBJECT_NOT_FOUND="object-not-found",Cg.BUCKET_NOT_FOUND="bucket-not-found",Cg.PROJECT_NOT_FOUND="project-not-found",Cg.QUOTA_EXCEEDED="quota-exceeded",Cg.UNAUTHENTICATED="unauthenticated",Cg.UNAUTHORIZED="unauthorized",Cg.UNAUTHORIZED_APP="unauthorized-app",Cg.RETRY_LIMIT_EXCEEDED="retry-limit-exceeded",Cg.INVALID_CHECKSUM="invalid-checksum",Cg.CANCELED="canceled",Cg.INVALID_EVENT_NAME="invalid-event-name",Cg.INVALID_URL="invalid-url",Cg.INVALID_DEFAULT_BUCKET="invalid-default-bucket",Cg.NO_DEFAULT_BUCKET="no-default-bucket",Cg.CANNOT_SLICE_BLOB="cannot-slice-blob",Cg.SERVER_FILE_WRONG_SIZE="server-file-wrong-size",Cg.NO_DOWNLOAD_URL="no-download-url",Cg.INVALID_ARGUMENT="invalid-argument",Cg.INVALID_ARGUMENT_COUNT="invalid-argument-count",Cg.APP_DELETED="app-deleted",Cg.INVALID_ROOT_OPERATION="invalid-root-operation",Cg.INVALID_FORMAT="invalid-format",Cg.INTERNAL_ERROR="internal-error",Cg.UNSUPPORTED_ENVIRONMENT="unsupported-environment";
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Mg{get path(){return this.path_}get isRoot(){return 0===this.path.length}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,t){let n;try{n=Mg.makeFromUrl(e,t)}catch(t){return new Mg(e,"")}if(""===n.path)return n;throw i=e,new kg(Sg.INVALID_DEFAULT_BUCKET,"Invalid default bucket '"+i+"'.");var i}static makeFromUrl(e,t){let n=null;const i="([A-Za-z0-9.\\-_]+)";const s=new RegExp("^gs://"+i+"(/(.*))?$","i");function r(e){e.path_=decodeURIComponent(e.path)}const o=t.replace(/[.]/g,"\\."),a=[{regex:s,indices:{bucket:1,path:3},postModify:function(e){"/"===e.path.charAt(e.path.length-1)&&(e.path_=e.path_.slice(0,-1))}},{regex:new RegExp(`^https?://${o}/v[A-Za-z0-9_]+/b/${i}/o(/([^?#]*).*)?$`,"i"),indices:{bucket:1,path:3},postModify:r},{regex:new RegExp(`^https?://${t===Ig?"(?:storage.googleapis.com|storage.cloud.google.com)":t}/${i}/([^?#]*)`,"i"),indices:{bucket:1,path:2},postModify:r}];for(let t=0;t<a.length;t++){const i=a[t],s=i.regex.exec(e);if(s){const e=s[i.indices.bucket];let t=s[i.indices.path];t||(t=""),n=new Mg(e,t),i.postModify(n);break}}if(null==n)throw function(e){return new kg(Sg.INVALID_URL,"Invalid URL '"+e+"'.")}(e);return n}constructor(e,t){this.bucket=e,this.path_=t}}class Ug{getPromise(){return this.promise_}cancel(e=!1){}constructor(e){this.promise_=Promise.reject(e)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function jg(e,t){const n=e>=500&&e<600,i=-1!==[408,429].indexOf(e),s=-1!==t.indexOf(e);return n||i||s}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e){if(0===e.length)return null;const t=e.lastIndexOf("/");return-1===t?"":e.slice(0,t)}(this._location.path);if(null===e)return null;const t=new Mg(this._location.bucket,e);return new Hg(this._service,t)}_throwIfRoot(e){if(""===this._location.path)throw function(e){return new kg(Sg.INVALID_ROOT_OPERATION,"The operation '"+e+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}(e)}constructor(e,t){this._service=e,this._location=t instanceof Mg?t:Mg.makeFromUrl(t,e.host)}}function Wg(e,t){const n=null==t?void 0:t[Eg];return null==n?null:Mg.makeFromBucketSpec(n,e)}class $g{get host(){return this._host}set host(e){this._host=e,null!=this._url?this._bucket=Mg.makeFromBucketSpec(this._url,e):this._bucket=Wg(e,this.app.options)}get maxUploadRetryTime(){return this._maxUploadRetryTime}set maxUploadRetryTime(e){Fg("time",0,Number.POSITIVE_INFINITY,e),this._maxUploadRetryTime=e}get maxOperationRetryTime(){return this._maxOperationRetryTime}set maxOperationRetryTime(e){Fg("time",0,Number.POSITIVE_INFINITY,e),this._maxOperationRetryTime=e}async _getAuthToken(){if(this._overrideAuthToken)return this._overrideAuthToken;const e=this._authProvider.getImmediate({optional:!0});if(e){const t=await e.getToken();if(null!==t)return t.accessToken}return null}async _getAppCheckToken(){const e=this._appCheckProvider.getImmediate({optional:!0});if(e){return(await e.getToken()).token}return null}_delete(){return this._deleted||(this._deleted=!0,this._requests.forEach((e=>e.cancel())),this._requests.clear()),Promise.resolve()}_makeStorageReference(e){return new Hg(this,e)}_makeRequest(e,t,n,i,s=!0){if(this._deleted)return new Ug(Og());{const r=function(e,t,n,i,s,r,o=!0){const a=Vg(e.urlParams),c=e.url+a,l=Object.assign({},e.headers);return function(e,t){t&&(e["X-Firebase-GMPID"]=t)}(l,t),function(e,t){null!==t&&t.length>0&&(e.Authorization="Firebase "+t)}(l,n),function(e,t){e["X-Firebase-Storage-Version"]="webjs/"+(null!=t?t:"AppManager")}(l,r),function(e,t){null!==t&&(e["X-Firebase-AppCheck"]=t)}(l,i),new Bg(c,e.method,l,e.body,e.successCodes,e.additionalRetryCodes,e.handler,e.errorHandler,e.timeout,e.progressCallback,s,o)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,this._appId,n,i,t,this._firebaseVersion,s);return this._requests.add(r),r.getPromise().then((()=>this._requests.delete(r)),(()=>this._requests.delete(r))),r}}async makeRequestWithTokens(e,t){const[n,i]=await Promise.all([this._getAuthToken(),this._getAppCheckToken()]);return this._makeRequest(e,t,n,i).getPromise()}constructor(e,t,n,i,s){this.app=e,this._authProvider=t,this._appCheckProvider=n,this._url=i,this._firebaseVersion=s,this._bucket=null,this._host=Ig,this._protocol="https",this._appId=null,this._deleted=!1,this._maxOperationRetryTime=12e4,this._maxUploadRetryTime=6e5,this._requests=new Set,this._bucket=null!=i?Mg.makeFromBucketSpec(i,this._host):Wg(this._host,this.app.options)}}const Kg="@firebase/storage",Gg="0.11.1",Qg="storage";function Xg(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return new $g(n,i,s,t,Fe)}Pe(new Q(Qg,Xg,"PUBLIC").setMultipleInstances(!0)),Be(Kg,Gg,""),Be(Kg,Gg,"esm2017");function Jg(e){if(e){let e=$s().currentUser.photoURL||"../images/profile_placeholder.png",n=Yg();St.userPicElement.style.backgroundImage="url("+((-1!==(t=e).indexOf("googleusercontent.com")&&-1===t.indexOf("?")?t+"?sz=150":t)+")"),St.userNameElement.textContent=n,St.userInfoElement.classList.remove("visually-hidden"),St.signOutButtonElement.classList.remove("visually-hidden"),St.signInButtonElement.classList.add("visually-hidden"),jt()}else St.userInfoElement.classList.add("visually-hidden"),St.signOutButtonElement.classList.add("visually-hidden"),St.signInButtonElement.classList.remove("visually-hidden");var t}function Yg(){return $s().currentUser.displayName}Rt.getGenres().then((e=>{localStorage.setItem("GENRES",JSON.stringify(e))})).catch((e=>console.log(e))),Pt.start(),Rt.getTrendMovie().then((e=>{const t=Dt.getDataTrendMovies(e.results),n=(0,pt.createMarkupFilmsList)(t);St.moviesList.innerHTML=n,_t(e)})).catch((e=>console.log(e))).finally((()=>{Pt.stop()}));const Zg=function(){if(tt&&tt.apiKey)return tt;throw new Error("No Firebase configuration object provided.\nAdd your web app's configuration object to firebase-config.js")}(),ey=new class{async signIn(){const e=new di;await ns($s(),e)}signOutUser(){G($s()).signOut()}initFirebaseAuth(){var e,t,n,i;e=$s(),t=Jg,G(e).onAuthStateChanged(t,n,i)}isUserSignedIn(){return!!$s().currentUser}async saveMovieData(e,t){if(!this.isUserSignedIn())throw"No autenteficate";const n=$s().currentUser.uid,i=Nm(jm(),this.NAME_COLLECTION_FILESTORAGE,t+n),s={name:Yg(),timestamp:new eg("serverTimestamp"),arrFilms:e};try{await bg(i,s)}catch(e){console.error("Error add new movie to Firebase Database",e)}}async readMovieData(e){if(!this.isUserSignedIn())return[];const t=$s().currentUser.uid,n=Nm(jm(),this.NAME_COLLECTION_FILESTORAGE,e+t),i=await vg(n);return i.exists()?i.data():[]}constructor(){this.NAME_COLLECTION_FILESTORAGE="storage_filmoteka"}};St.signInWithGoogle.addEventListener("click",ey.signIn),St.signOutButtonElement.addEventListener("click",ey.signOutUser),Ve(Zg),ey.initFirebaseAuth();
//# sourceMappingURL=index.3b67f0f7.js.map

 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fe="9.17.1";function Ve(e,t={}){let n=e;if("object"!=typeof t){t={name:t}}const i=Object.assign({name:xe,automaticDataCollectionEnabled:!1},t),s=i.name;if("string"!=typeof s||!s)throw Me.create("bad-app-name",{appName:String(s)});if(n||(n=N()),!n)throw Me.create("no-options");const r=Le.get(s);if(r){if(j(n,r.options)&&j(i,r.config))return r;throw Me.create("duplicate-app",{appName:s})}const o=new Y(s);for(const e of De.values())o.addComponent(e);const a=new Ue(n,i,o);return Le.set(s,a),a}function je(e=xe){const t=Le.get(e);if(!t&&e===xe)return Ve();if(!t)throw Me.create("no-app",{appName:e});return t}function Be(e,t,n){var i;let s=null!==(i=Ae[e])&&void 0!==i?i:e;n&&(s+=`-${n}`);const r=s.match(/\s|\//),o=t.match(/\s|\//);if(r||o){const e=[`Unable to register library "${s}" with version "${t}":`];return r&&e.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&o&&e.push("and"),o&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void Ne.warn(e.join(" "))}Pe(new Q(`${s}-version`,(()=>({library:s,version:t})),"VERSION"))}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var et;et="",Pe(new Q("platform-logger",(e=>new ke(e)),"PRIVATE")),Pe(new Q("heartbeat",(e=>new Xe(e)),"PRIVATE")),Be(Ce,Se,et),Be(Ce,Se,"esm2017"),Be("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nd=new Bu(Al.comparator);function id(){return nd}const sd=new Bu(Al.comparator);function rd(...e){let t=sd;for(const n of e)t=t.insert(n.key,n);return t}function od(e){let t=sd;return e.forEach(((e,n)=>t=t.insert(e,n.overlayedDocument))),t}function ad(){return ld()}function cd(){return ld()}function ld(){return new td((e=>e.toString()),((e,t)=>e.isEqual(t)))}const ud=new Bu(Al.comparator),hd=new Hu(Al.comparator);function dd(...e){let t=hd;for(const n of e)t=t.add(n);return t}const fd=new Hu(_l);function pd(){return fd}
/**
 * @license
 * Copyright 2017 Google LLC
 *

 ...
 * limitations under the License.
 */
class Fs extends zs{static credential(t){return Os._fromParams({providerId:Fs.PROVIDER_ID,signInMethod:Fs.FACEBOOK_SIGN_IN_METHOD,accessToken:t})}static credentialFromResult(t){return Fs.credentialFromTaggedObject(t)}static credentialFromError(t){return Fs.credentialFromTaggedObject(t.customData||{})}static credentialFromTaggedObject({_tokenResponse:t}){if(!t||!("oauthAccessToken"in t))return null;if(!t.oauthAccessToken)return null;try{return Fs.credential(t.oauthAccessToken)}catch(t){return null}}constructor(){super("facebook.com")}}Fs.FACEBOOK_SIGN_IN_METHOD="facebook.com",Fs.PROVIDER_ID="facebook.com";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class js extends zs{static credential(t,e){return Os._fromParams({providerId:js.PROVIDER_ID,signInMethod:js.GOOGLE_SIGN_IN_METHOD,idToken:t,accessToken:e})}static credentialFromResult(t){return js.credentialFromTaggedObject(t)}static credentialFromError(t){return js.credentialFromTaggedObject(t.customData||{})}static credentialFromTaggedObject({_tokenResponse:t}){if(!t)return null;const{oauthIdToken:e,oauthAccessToken:n}=t;if(!e&&!n)return null;try{return js.credential(e,n)}catch(t){return null}}constructor(){super("google.com"),this.addScope("profile")}}js.GOOGLE_SIGN_IN_METHOD="google.com",js.PROVIDER_ID="google.com";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xa=new Bo(3e4,6e4);function Ka(){const t=sa().___jsl;if(null==t?void 0:t.H)for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let e=0;e<t.CP.length;e++)t.CP[e]=null}let Ga=null;function Ja(t){return Ga=Ga||function(t){return new Promise(((e,n)=>{var i,r,o;function s(){Ka(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Ka(),n(No(t,"network-request-failed"))},timeout:Xa.get()})}if(null===(r=null===(i=sa().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)e(gapi.iframes.getContext());else{if(!(null===(o=sa().gapi)||void 0===o?void 0:o.load)){const e=wa("iframefcb");return sa()[e]=()=>{gapi.load?s():n(No(t,"network-request-failed"))},ba(`https://apis.google.com/js/api.js?onload=${e}`).catch((t=>n(t)))}s()}})).catch((t=>{throw Ga=null,t}))}(t),Ga}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t)}?${j(a).slice(1)}`}const dl="webStorageSupport";const pl=class{async _openPopup(t,e,n,i){var r;Ao(null===(r=this.eventManagers[t._key()])||void 0===r?void 0:r.manager,"_initialize() not called before _openPopup()");return cl(t,fl(t,e,n,Po(),i),ra())}async _openRedirect(t,e,n,i){var r;return await this._originValidation(t),r=fl(t,e,n,Po(),i),sa().location.href=r,new Promise((()=>{}))}_initialize(t){const e=t._key();if(this.eventManagers[e]){const{manager:t,promise:n}=this.eventManagers[e];return t?Promise.resolve(t):(Ao(n,"If manager is not set, promise should be"),n)}const n=this.initAndGetManager(t);return this.eventManagers[e]={promise:n},n.catch((()=>{delete this.eventManagers[e]})),n}async initAndGetManager(t){const e=await async function(t){const e=await Ja(t),n=sa().gapi;return So(n,t,"internal-error"),e.open({where:document.body,url:nl(t),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:tl,dontclear:!0},(e=>new Promise((async(n,i)=>{await e.restyle({setHideOnLeave:!1});const r=No(t,"network-request-failed"),o=sa().setTimeout((()=>{i(r)}),Ya.get());function s(){sa().clearTimeout(o),n(e)}e.ping(s).then(s,(()=>{i(r)}))}))))}(t),n=new Fa(t);return e.register("authEvent",(e=>{So(null==e?void 0:e.authEvent,t,"invalid-auth-event");return{status:n.onEvent(e.authEvent)?"ACK":"ERROR"}}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[t._key()]={manager:n},this.iframes[t._key()]=e,n}_isIframeWebStorageSupported(t,e){this.iframes[t._key()].send(dl,{type:dl},(n=>{var i;const r=null===(i=null==n?void 0:n[0])||void 0===i?void 0:i[dl];void 0!==r&&e(!!r),Io(t,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(t){const e=t._key();return this.originValidationPromises[e]||(this.originValidationPromises[e]=qa(t)),this.originValidationPromises[e]}get _shouldInitProactively(){return ws()||fs()||vs()}constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=na,this._completeRedirectFn=za,this._overrideRedirectResult=Ma}};var ml="@firebase/auth",gl="0.21.3";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class jf{static fromPath(t){return new jf(Ff.fromString(t))}static fromName(t){return new jf(Ff.fromString(t).popFirst(5))}static empty(){return new jf(Ff.emptyPath())}get collectionGroup(){return this.path.popLast().lastSegment()}hasCollectionId(t){return this.path.length>=2&&this.path.get(this.path.length-2)===t}getCollectionGroup(){return this.path.get(this.path.length-2)}getCollectionPath(){return this.path.popLast()}isEqual(t){return null!==t&&0===Ff.comparator(this.path,t.path)}toString(){return this.path.toString()}static comparator(t,e){return Ff.comparator(t.path,e.path)}static isDocumentKey(t){return t.length%2==0}static fromSegments(t){return new jf(new Ff(t.slice()))}constructor(t){this.path=t}}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
class Wd{toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(t,e){return new Wd(t,e)}get root(){const t=new Pd(this._location.bucket,"");return this._newRef(this._service,t)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return jd(this._location.path)}get storage(){return this._service}get parent(){const t=
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t,this._appId,n,i,e,this._firebaseVersion,r);return this._requests.add(o),o.getPromise().then((()=>this._requests.delete(o)),(()=>this._requests.delete(o))),o}}async makeRequestWithTokens(t,e){const[n,i]=await Promise.all([this._getAuthToken(),this._getAppCheckToken()]);return this._makeRequest(t,e,n,i).getPromise()}constructor(t,e,n,i,r){this.app=t,this._authProvider=e,this._appCheckProvider=n,this._url=i,this._firebaseVersion=r,this._bucket=null,this._host=xd,this._protocol="https",this._appId=null,this._deleted=!1,this._maxOperationRetryTime=12e4,this._maxUploadRetryTime=6e5,this._requests=new Set,this._bucket=null!=i?Pd.makeFromBucketSpec(i,this._host):Hd(this._host,this.app.options)}}const qd="@firebase/storage",$d="0.11.1",Xd="storage";function Kd(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),i=t.getProvider("auth-internal"),r=t.getProvider("app-check-internal");return new Vd(n,i,r,e,Ut)}Ot(new K(Xd,Kd,"PUBLIC").setMultipleInstances(!0)),Ft(qd,$d,""),Ft(qd,$d,"esm2017");function Gd(t){if(t){let t=xl().currentUser.photoURL||"../images/profile_placeholder.png",n=xl().currentUser.displayName;jr.userPicElement.style.backgroundImage="url("+((-1!==(e=t).indexOf("googleusercontent.com")&&-1===e.indexOf("?")?e+"?sz=150":e)+")"),jr.userNameElement.textContent=n,jr.userInfoElement.classList.remove("visually-hidden"),jr.signOutButtonElement.classList.remove("visually-hidden"),jr.signInButtonElement.classList.add("visually-hidden"),mo()}else jr.userInfoElement.classList.add("visually-hidden"),jr.signOutButtonElement.classList.add("visually-hidden"),jr.signInButtonElement.classList.remove("visually-hidden");var e}ao.getGenres().then((t=>{localStorage.setItem("GENRES",JSON.stringify(t))})).catch((t=>console.log(t))),lo.start(),ao.getTrendMovie().then((t=>{const e=Rr(so.getDataTrendMovies(t.results));jr.moviesList.innerHTML=e,Ur(t)})).catch((t=>console.log(t))).finally((()=>{lo.stop()}));const Jd=function(){if(te&&te.apiKey)return te;throw new Error("No Firebase configuration object provided.\nAdd your web app's configuration object to firebase-config.js")}(),Yd=new class{async signIn(){const t=new js;await Aa(xl(),t)}signOutUser(){X(xl()).signOut()}initFirebaseAuth(){var t,e,n,i;t=xl(),e=Gd,X(t).onAuthStateChanged(e,n,i)}};jr.signInWithGoogle.addEventListener("click",Yd.signIn),jr.signOutButtonElement.addEventListener("click",Yd.signOutUser),Bt(Jd),Yd.initFirebaseAuth();
//# sourceMappingURL=index.43abd38d.js.map

...
const refs = {
  openTeamModalBtn: document.querySelector('[data-modal-open-team-lib]'),
  closeTeamModalBtn: document.querySelector('[data-modal-close-team-lib]'),
  backdropFooter: document.querySelector('.backdrop-footer-lib'),
};

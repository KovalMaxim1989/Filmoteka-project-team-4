 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xa=new Uo(3e4,6e4);function Ka(){const t=sa().___jsl;if(null==t?void 0:t.H)for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let e=0;e<t.CP.length;e++)t.CP[e]=null}let Ga=null;function Ja(t){return Ga=Ga||function(t){return new Promise(((e,n)=>{var i,r,o;function s(){Ka(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Ka(),n(_o(t,"network-request-failed"))},timeout:Xa.get()})}if(null===(r=null===(i=sa().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)e(gapi.iframes.getContext());else{if(!(null===(o=sa().gapi)||void 0===o?void 0:o.load)){const e=wa("iframefcb");return sa()[e]=()=>{gapi.load?s():n(_o(t,"network-request-failed"))},ba(`https://apis.google.com/js/api.js?onload=${e}`).catch((t=>n(t)))}s()}})).catch((t=>{throw Ga=null,t}))}(t),Ga}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
